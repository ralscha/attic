...
var sqrlApiDomain = 'https://192.168.2.10';	// the location of the SQRL server
	...
	syncQuery1.onreadystatechange = function() {
		if ( syncQuery1.readyState === 4 ) {
			if ( syncQuery1.status === 200 ) {
				...
				setTimeout(pollForNextPage, 2000); // if we do not obtain a /pag.sqrl, wait 1/2 second and retry
			}
		}	
	};
