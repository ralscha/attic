/* <debug> */
Ext.Loader.setPath('Ext.ux', 'resources/ext/5.1.2.748/ext-ux/examples');
/* </debug> */
Ext.define('Starter.Application', {
	extend: 'Ext.app.Application',
	name: 'Starter',
	requires: [ 'Starter.overrides.AccessKeyConfig', 'Starter.overrides.window.Window', 
	            'Starter.ux.form.trigger.Clear', 'Starter.Util', 'Ext.ux.TabReorderer', 
	            'Ext.ux.TabCloseMenu', 'Starter.RemoteStateProvider', 'Starter.store.Languages' ],
