Ext.define('Sales.controller.quotation.List', {
    ...
    init: function() {
        ...
        me.control({
            ...
            'myapp-quotation-list button[action=add]': {
                'click': me.onItemAdd
            },
            'myapp-quotation-list button[action=edit]': {
                'click': me.onItemEdit
            },
            'myapp-quotation-list button[action=remove]': {
                'click': me.onItemRemove
            },
            'myapp-quotation-list button[action=refresh]': {
