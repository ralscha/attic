Ext.define('Golb.view.base.ViewController', {
	extend: 'Ext.app.ViewController',
	requires: 'Golb.view.base.GridCellToolTip',
		...
		if (form.isValid()) {
			...
			record.save({
				...
				success: function(record, operation) {
					...
					if (this.getBackAfterSave && this.getBackAfterSave()) {
						this.back();
					}
