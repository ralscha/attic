...
public class AccessLogService {
	...
	public ExtDirectStoreResult<AccessLog> read(ExtDirectStoreReadRequest request,
		...
		PeriodFormatter minutesAndSeconds = new PeriodFormatterBuilder().appendMinutes()
				.appendSuffix(
						" " + this.messageSource.getMessage("accesslog_minute", null,
								locale),
						" " + this.messageSource.getMessage("accesslog_minutes", null,
								locale))
				.appendSeparator(
						" " + this.messageSource.getMessage("accesslog_and", null, locale)
								+ " ")
				.printZeroRarelyLast().appendSeconds()
				.appendSuffix(
						" " + this.messageSource.getMessage("accesslog_second", null,
								locale),
						" " + this.messageSource.getMessage("accesslog_seconds", null,
								locale))
				.toFormatter();
