...
import ch.rasc.changelog.util.DateTimeSerializer;
import ch.rasc.extclassgenerator.Model;
import ch.rasc.extclassgenerator.ModelField;

@Model(value = "Changelog.model.LoggingEvent", readMethod = "loggingEventService.read",
		paging = true)
public class LoggingEvent {
	...
	public LoggingEvent(ch.rasc.changelog.entity.LoggingEvent event) {
