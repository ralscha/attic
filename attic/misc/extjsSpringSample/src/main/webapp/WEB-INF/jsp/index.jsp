...
<head>
    ...
    <link href="http://extjs.cachefly.net/ext-3.3.0/examples/ux/css/RowEditor.css" rel="stylesheet"  type="text/css" />
    ...
    <script type="text/javascript" src="http://extjs.cachefly.net/ext-3.3.0/examples/ux/RowEditor.js"></script>
    <script type="text/javascript">
        Ext.BLANK_IMAGE_URL = "http://extjs.cachefly.net/ext-3.3.0/resources/images/default/s.gif";
    </script>
    <script type="text/javascript" src="<c:url value="/resources/js/app.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/app/api-debug.js?apiNs=App&actionNs=App"/>"></script>
</head>
<body>
