...
public class JdbcContactDao implements ContactDao {
    ...
    public void init(DataSource dataSource) {
        ...
        this.simpleInsert.withTableName("contacts").usingGeneratedKeyColumns(
                "id");
    }
    ...
    public Contact findById(Integer id) {
        ...
        Contact contact;
        try {
            contact = this.simpleJdbcTemplate.queryForObject(SQL_SELECT
                    + "WHERE id=?",
    ...
    public List<Contact> searchForContact(String criteria) {
        ...
        List<Contact> contacts = this.simpleJdbcTemplate
                .query(SQL_SELECT
                        + "WHERE first_name LIKE :criteria OR last_name LIKE :criteria",
