...
/**
 * Deserializer to deal with dates coming in via JSON. It recognizes dates in
 * the standard ISO format, like 2010-07-01T15:30:00.
 */
public class ExtDateDeserializer extends JsonDeserializer<Date> {

    private final Logger logger = LoggerFactory
            .getLogger(ExtDateSerializer.class);
