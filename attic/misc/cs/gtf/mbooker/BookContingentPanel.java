...
public class BookContingentPanel extends BookPanel {
	...
	public BookContingentPanel() {
       ...
       group.add(creditButton);
		...
		if (cu != null) 
			contLiability.setExchange_rate(cu.getInternalRate());
		...
		isoList.addActionListener(new ActionListener() {
                              			public void actionPerformed(ActionEvent e) {
                              				...
                              				if (curr != null) 
                              					contLiability.setExchange_rate(curr.getInternalRate());
                              				checkEffectButton();
                              			}
                              		}
                             		);
