...
public class FirmLiability extends Liability {
	...
	public FirmLiability(int _sequence_number, String _gtf_number, 
		                 String _deb_acct_number,
                     	String _cre_acct_number, String _value_date,
		                 String _currency,	double _amount, java.math.BigDecimal _exchange_rate, 
		                 	String _gtf_proc_center, String _customer_ref,
		...
		super(_sequence_number, _gtf_number, _currency, _amount, _exchange_rate,
      		_gtf_proc_center, _customer_ref, _gtf_type, _dossier_item, _bu_code, _creator_pid,
      		_timestamp);
