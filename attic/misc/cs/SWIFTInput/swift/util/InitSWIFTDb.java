	...
	private void createTables() {
		try {
			statement.executeUpdate("CREATE TABLE SWIFTHeader("+
							  ...
							  "constraint tosn_uniq primary key (TOSN))");
			...
			statement.executeUpdate("CREATE TABLE MessageLine("+
							  ...
							  "FieldTag  CHAR(3),"+
							  "MsgLine  CHAR(69),"+
							  "constraint toli_uniq primary key(TOSN, Lineno))");
	
			
			statement.executeUpdate("CREATE TABLE SWIFTAddress("+
									"Swift CHAR(11) NOT NULL,"+
									"Address CHAR(70) NOT NULL,"+
									"constraint swift_uniq primary key(Swift))");
			...
			statement.executeUpdate("CREATE TABLE State("+
									...
									"constraint order_uniq primary key(OrderNo))");
