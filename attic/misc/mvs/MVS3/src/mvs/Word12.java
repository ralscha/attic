/**
 * Cache' Java Class Generated for class mvs.Word12
 *
 * @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12</A>
**/
...
public class Word12 extends Persistent {

    private static String CACHE_CLASS_NAME = "mvs.Word12";
    /**
           NB: DO NOT USE IN APPLICATION!
           Use <code>Word12._open</code> instead.
           <p>
    ...
    */
    public Word12 (CacheObject ref) throws CacheException {
        super (ref);
    }
    /**
       ...
       @throws CacheException in case of error.
              ...
              @see #_open(com.intersys.objects.Database, com.intersys.objects.Id)
     */
    public Word12 (Database db) throws CacheException {
    ...
    /**
       ...
       object. This object may be of <code>Word12</code> or of
      any of its subclasses. Cast to <code>Word12</code> is
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Id)
           @see #Word12(com.intersys.objects.Database)
     */
    ...
    /**
       Returns class name of the class Word12 as it is in
   ...
   */
    ...
    public static void checkAllFieldsValid(Database db ) throws CacheException {
        checkAllFieldsValid(db, CACHE_CLASS_NAME, Word12.class);
    }
    ...
    public static void checkAllMethods(Database db ) throws CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, Word12.class);
    }
    ...
    /**
       ...
       @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#total"> total</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws CacheException if any error occurred during value retrieval.
       @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#word1"> word1</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws CacheException if any error occurred during value retrieval.
       @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#word2"> word2</A>
    */
    ...
    */
    ...
    private static int ii_word3ref = 6;
    private static int jj_word3ref = 0;
    private static int kk_word3ref = 6;
    /**
       Verifies that indexes for property <code>word3ref</code> in
       zObjVal are the same as in Cache. It does not return anything
       but it throws an exception in case of inconsistency.
     ...
     */
    public static void checkword3refValid (Database db) throws CacheException {
        checkZobjValid(db, CACHE_CLASS_NAME, "word3ref",ii_word3ref, jj_word3ref, kk_word3ref);
    }
    /**
       Returns value of property <code>word3ref</code>
       @return current value of <code>word3ref</code> represented as
       <code>java.lang.Integer</code>

       @throws CacheException if any error occurred during value retrieval.
       @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#word3ref"> word3ref</A>
    */
    public java.lang.Integer getword3ref() throws CacheException {
        Dataholder dh = mInternal.getProperty(ii_word3ref,
                                                jj_word3ref,
                                                Database.RET_PRIM,
                                                "word3ref");
       return dh.getInteger();
    ...
    /**
       Sets new value for <code>word3ref</code>.
       @param value new value to be set represented as
       <code>java.lang.Integer</code>.
       @throws CacheException if any error occurred during value setting.
       @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#word3ref"> word3ref</A>
    */
    public void setword3ref(java.lang.Integer value) throws CacheException {
        Dataholder dh = new Dataholder (value);
        mInternal.setProperty(ii_word3ref, jj_word3ref,kk_word3ref, Database.RET_PRIM, "word3ref", dh);
        return;
    }
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%BMEBuilt"> Method %BMEBuilt</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%BuildIndices"> Method %BuildIndices</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%CheckUnique"> Method %CheckUnique</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%Delete"> Method %Delete</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%DeleteExtent"> Method %DeleteExtent</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%DeleteId"> Method %DeleteId</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%Exists"> Method %Exists</A>
    */
    ...
    */
    ...
    /**
     ...
     @param id represented as java.lang.String
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%ExistsId"> Method %ExistsId</A>
    */
    ...
    /**
     ...
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%Extends"> Method %Extends</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%GetParameter"> Method %GetParameter</A>
    */
    ...
    */
    ...
    /**
     ...
     @param isclass represented as java.lang.String
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%IsA"> Method %IsA</A>
    */
    ...
    /**
     ...
     @param db represented as Database
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%KillExtent"> Method %KillExtent</A>
    */
    ...
    /**
     ...
     @param db represented as Database
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%PackageName"> Method %PackageName</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%PurgeIndices"> Method %PurgeIndices</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%SortBegin"> Method %SortBegin</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.Word12#%SortEnd"> Method %SortEnd</A>
    */
    ...
    */
    ...
    public static CacheQuery query_Extent (Database db) throws CacheException {
        return new CacheQuery(db, "mvs.Word12_Extent", 0, 0);
    }
