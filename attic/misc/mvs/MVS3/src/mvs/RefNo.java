/**
 * Cache' Java Class Generated for class mvs.RefNo
 *
 * @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo</A>
**/
...
public class RefNo extends Persistent {

    private static String CACHE_CLASS_NAME = "mvs.RefNo";
    /**
           NB: DO NOT USE IN APPLICATION!
           Use <code>RefNo._open</code> instead.
           <p>
    ...
    */
    public RefNo (CacheObject ref) throws CacheException {
        super (ref);
    }
    /**
       ...
       @throws CacheException in case of error.
              ...
              @see #_open(com.intersys.objects.Database, com.intersys.objects.Id)
     */
    public RefNo (Database db) throws CacheException {
    ...
    /**
       ...
       object. This object may be of <code>RefNo</code> or of
      any of its subclasses. Cast to <code>RefNo</code> is
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Id)
           @see #RefNo(com.intersys.objects.Database)
     */
    ...
    /**
       Returns class name of the class RefNo as it is in
   ...
   */
    ...
    public static void checkAllFieldsValid(Database db ) throws CacheException {
        checkAllFieldsValid(db, CACHE_CLASS_NAME, RefNo.class);
    }
    ...
    public static void checkAllMethods(Database db ) throws CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, RefNo.class);
    }
    private static int ii_refno = 3;
    private static int jj_refno = 0;
    private static int kk_refno = 3;
    /**
       Verifies that indexes for property <code>refno</code> in
       zObjVal are the same as in Cache. It does not return anything
       but it throws an exception in case of inconsistency.
     ...
     */
    public static void checkrefnoValid (Database db) throws CacheException {
        checkZobjValid(db, CACHE_CLASS_NAME, "refno",ii_refno, jj_refno, kk_refno);
    }
    /**
       Returns value of property <code>refno</code>
       @return current value of <code>refno</code> represented as
       <code>java.lang.Integer</code>

       @throws CacheException if any error occurred during value retrieval.
       @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#refno"> refno</A>
    */
    public java.lang.Integer getrefno() throws CacheException {
        Dataholder dh = mInternal.getProperty(ii_refno,
                                                jj_refno,
                                                Database.RET_PRIM,
                                                "refno");
    ...
    /**
       Sets new value for <code>refno</code>.
       @param value new value to be set represented as
       <code>java.lang.Integer</code>.
       @throws CacheException if any error occurred during value setting.
       @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#refno"> refno</A>
    */
    public void setrefno(java.lang.Integer value) throws CacheException {
        Dataholder dh = new Dataholder (value);
        mInternal.setProperty(ii_refno, jj_refno,kk_refno, Database.RET_PRIM, "refno", dh);
        return;
    }
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%BMEBuilt"> Method %BMEBuilt</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%BuildIndices"> Method %BuildIndices</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%CheckUnique"> Method %CheckUnique</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%Delete"> Method %Delete</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%DeleteExtent"> Method %DeleteExtent</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%DeleteId"> Method %DeleteId</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%Exists"> Method %Exists</A>
    */
    ...
    */
    ...
    /**
     ...
     @param id represented as java.lang.String
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%ExistsId"> Method %ExistsId</A>
    */
    ...
    /**
     ...
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%Extends"> Method %Extends</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%GetParameter"> Method %GetParameter</A>
    */
    ...
    */
    ...
    /**
     ...
     @param isclass represented as java.lang.String
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%IsA"> Method %IsA</A>
    */
    ...
    /**
     ...
     @param db represented as Database
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%KillExtent"> Method %KillExtent</A>
    */
    ...
    /**
     ...
     @param db represented as Database
     @throws CacheException if any error occured while running the method.
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%PackageName"> Method %PackageName</A>
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%PurgeIndices"> Method %PurgeIndices</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%SortBegin"> Method %SortBegin</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://fast:1972/apps/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=MVS&CLASSNAME=mvs.RefNo#%SortEnd"> Method %SortEnd</A>
    */
    ...
    */
    ...
    public static CacheQuery query_Extent (Database db) throws CacheException {
        return new CacheQuery(db, "mvs.RefNo_Extent", 0, 0);
    }
