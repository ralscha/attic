...
public class Main2 {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      RuleSet ruleSet = new RuleSet("one");
      

      Rule rule = new Rule("kleiner10");
      rule.addParameterDeclaration( eingangDecl );
      rule.addCondition(new ExprCondition("eingang.getDelta() <= 10", rule.getAllDeclarations()));
      ...
      rule2.addCondition(new ExprCondition("eingang.getDelta() <= 50 && eingang.getDelta() > 10", rule2.getAllDeclarations()));
      ...
      rule3.addCondition(new ExprCondition("eingang.getDelta() > 50", rule3.getAllDeclarations()));
