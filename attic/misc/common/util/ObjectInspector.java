    ...
    private void openTable( Object obj, int cols ) throws IOException
      {
        ...
        out.println( "<A NAME=\""+ID.intValue()+"\"></A>" );
        out.println( "<TABLE BORDER=\"1\" CELLPADDING=\"0\" CELLSPACING=\"0\" WIDTH=\"100%\">" );
        out.println( "<TR BGCOLOR=\"#C0C0C0\">" );
        out.println( "<TD COLSPAN=\""+cols+"\"><FONT SIZE=\"+2\"><B>"+getFriendlyName(obj.getClass())+"#"+ID.intValue()+"</B></FONT></TD>" );
        out.println( "</TR>" );
      }
    ...
    private void outputValue( Object value, boolean primitive ) throws IOException
      {
        ...
        if ( (value == null) ||
        ...
        else
          {
            ...
            out.print( "<A HREF=\"#"+ID.intValue()+"\">"+getFriendlyName(value.getClass())+"#"+ID.intValue()+"</A>" );
          }
        out.println( "</TD>" );
      }
