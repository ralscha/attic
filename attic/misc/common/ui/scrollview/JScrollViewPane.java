...
public class JScrollViewPane extends JScrollPane {
	...
	public JScrollViewPane(int vsbPolicy, int hsbPolicy, boolean isDynamic) {
		super(vsbPolicy, hsbPolicy);
		this.isDynamic = isDynamic;
	}

	public JScrollViewPane(Component view, int vsbPolicy, int hsbPolicy, boolean isDynamic) {
