...
import ch.ess.task.resource.UserConfig;
...
public class PopupCalendarJsTag extends VelocityTag {
  ...
  public int doStartTag() throws JspException {
    ...
    try {
      String imageDir = TagUtils.getInstance().computeURL(pageContext, null, null, "/images/", null, null, null, true);
      String jspath =
        TagUtils.getInstance().computeURL(pageContext, null, null, "/scripts/popcalendar.js", null, null, null, true);
