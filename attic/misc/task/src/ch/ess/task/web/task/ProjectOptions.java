...
public class ProjectOptions extends Options {
  ...
  public void init() throws HibernateException {
    ...
    try {
      ...
      List resultList = HibernateSession.currentSession().find("from Project as p");
      ...
      while (it.hasNext()) {
        ...
        getLabelValue().add(new LabelValueBean((String)entry.getKey(), ((Project)entry.getValue()).getId().toString()));
      }
