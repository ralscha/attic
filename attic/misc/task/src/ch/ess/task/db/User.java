...
/** A business entity class representing an User
  ...
  * @hibernate.class  table="taskUser" lazy="true"
  */
...
public class User extends Persistent {
  ...
  private Set taskCreatedBy;
  private Set taskAssignedTo;
  ...
  */
  ...
  /**      
     * @hibernate.set lazy="true" table="taskUserConfiguration" cascade="all" inverse="true"
     * @hibernate.collection-key  column="userId"     
     * @hibernate.collection-one-to-many  class="ch.ess.task.db.UserConfiguration"
     */
  ...
  /**      
     * @hibernate.set lazy="true" table="taskUserRole" cascade="all-delete-orphan" inverse="true"
     * @hibernate.collection-key  column="userId"     
     * @hibernate.collection-one-to-many  class="ch.ess.task.db.UserRole"
     */
  ...
  /**      
     ...
     * @hibernate.collection-key  column="byUserId"     
     * @hibernate.collection-one-to-many  class="ch.ess.task.db.Task"
     */
  public Set getTaskCreatedBy() {
    if (taskCreatedBy == null) {
      taskCreatedBy = new HashSet();
    }
  ...
  /**      
     * @hibernate.set lazy="true" table="taskTask" cascade="none" inverse="true"
     * @hibernate.collection-key  column="toUserId"     
     * @hibernate.collection-one-to-many  class="ch.ess.task.db.Task"
     */
  public Set getTaskAssignedTo() {
    if (taskAssignedTo == null) {
      taskAssignedTo = new HashSet();
    }
    return taskAssignedTo;
  }

  public void setTaskCreatedBy(Set set) {
    taskCreatedBy = set;
  }

  public void setTaskAssignedTo(Set set) {
    taskAssignedTo = set;
  }
  ...
  public boolean canDelete() throws HibernateException {
    ...
    if (getId() != null) {
      return ((HibernateSession.collectionSize(taskAssignedTo) == 0) 
            && (HibernateSession.collectionSize(taskCreatedBy) == 0));
    } 
