...
<misc:initSelectOptions id="roleOption" type="ch.ess.task.web.RoleOptions" scope="session" />
...
<td>
   <html:select property="value(roleId)">
...
<display:table id="test" name="result" export="false" scope="session" pagesize="10" requestURI="<%= (String)pageContext.getAttribute("requestURI") %>" sort="list" defaultsort="1" class="list" decorator="ch.ess.task.web.user.UserDecorator">
  ...
  <display:column width="97" property="role" align="left" maxLength="13" nowrap="nowrap" headerClass="sortable" sortable="true">    
    <misc:title><bean:message key="user.roles"/></misc:title>
  </display:column>
...
<input type="hidden" name="value(path)" value="/newUser.do" />
