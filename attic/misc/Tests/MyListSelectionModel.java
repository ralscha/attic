...
public class MyListSelectionModel extends DefaultListSelectionModel {
	...
	/*   Change the selection with the effect of first clearing the values
	  ...
	  */
	private void changeSelection(int clearMin, int clearMax, int setMin, int setMax) {
		changeSelection(clearMin, clearMax, setMin, setMax, false);
	}
	...
	public void addSelectionInterval(int index0, int index1) {
		System.out.println("addSelectionInterval");
		if (index0 == -1 || index1 == -1) {
			return;
		}
	...
	public Object clone() throws CloneNotSupportedException {
		MyListSelectionModel clone = (MyListSelectionModel) super.clone();
