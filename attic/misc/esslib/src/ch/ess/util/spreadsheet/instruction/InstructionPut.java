/*
 * $Header: /home/cvsroot/pbroker/src/ch/ess/util/spreadsheet/InstructionPut.java,v 1.1.1.1 2002/02/26 06:46:55 sr Exp $
 * $Revision: 1.1.1.1 $
 ...
 */
public class InstructionPut extends Instruction {
   ...
   */
  public InstructionPut(SpreadsheetTableModel spreadSheet) {
    super(spreadSheet);
  }
   ...
   * @param spreadSheet ch.ess.util.spreadsheet.SpreadsheetTableModel
   */
  public InstructionPut(SpreadsheetTableModel spreadSheet, boolean executeAction) {
  ...
  public void execute() {
    ...
    if (SpreadsheetCell.class.isAssignableFrom(c.getClass())) {
      ...
      ((SpreadsheetCell)c).putValue(p, executeAction);
    }
  }
   ...
   */
  public String getJs() {
    return executeAction ? "iPutX()" : "iPut()";
  }
}
