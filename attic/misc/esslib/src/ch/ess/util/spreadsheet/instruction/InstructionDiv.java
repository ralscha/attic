/*
 * $Header: /home/cvsroot/pbroker/src/ch/ess/util/spreadsheet/InstructionDiv.java,v 1.1.1.1 2002/02/26 06:46:55 sr Exp $
 * $Revision: 1.1.1.1 $
 ...
 */
public class InstructionDiv extends BinaryNumericInstruction {

  /**
   * InstructionAdd constructor comment.
   * @param spreadSheet ch.ess.util.spreadsheet.SpreadsheetTableModel
   */
  public InstructionDiv(SpreadsheetTableModel spreadSheet) {
    super(spreadSheet);
  }
   ...
   * @param spreadSheet ch.ess.util.spreadsheet.SpreadsheetTableModel
   */
  public InstructionDiv(SpreadsheetTableModel spreadSheet, Double nullReplacement) {
