/*
 * $Header: /home/cvsroot/pbroker/src/ch/ess/util/spreadsheet/InstructionDtoHM.java,v 1.1.1.1 2002/02/26 06:46:55 sr Exp $
 * $Revision: 1.1.1.1 $
 ...
 */
public class InstructionDtoHM extends UnaryNumericInstruction {

  /**
   * InstructionHMtoD constructor comment.
   * @param spreadSheet ch.ess.util.spreadsheet.SpreadsheetTableModel
   */
  public InstructionDtoHM(SpreadsheetTableModel spreadSheet) {
    super(spreadSheet);
  }
   ...
   */
  public InstructionDtoHM(SpreadsheetTableModel spreadSheet, Double nullReplacement) {
  ...
  public double compute(double param) {
    ...
    return ((p.getIPart() + ((((double)Math.round(p.getFPart() * 60)) / 100))) * p.getSPart());
  }
