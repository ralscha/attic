...
public class Lock_manager {
  ...
  private static void acquire(Object[] locks, long timeout) throws InterruptedException, Semaphore.Timed_out {
    int current_lock = 0;
    ...
    } catch (InterruptedException exception) { // Release all locks up to (but not including)
      // locks[current_lock];
