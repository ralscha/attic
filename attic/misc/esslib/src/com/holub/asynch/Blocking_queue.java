...
public final class Blocking_queue {
   ...
   *  dequeued.
   **/
  public synchronized final void enqueue(Object new_element) throws Closed, Full {
  ...
  public synchronized final void enqueue(final Object new_element, final long timeout, final Runnable on_removal) {
    enqueue(new_element);
  ...
  public synchronized final void enqueue_final_item(Object last) throws Closed {
    enqueue(last);
  ...
  public synchronized final Object dequeue(long timeout) throws InterruptedException, Closed, Semaphore.Timed_out {
      ...
      if (elements.size() <= 0) {
        ...
        while (elements.size() <= 0) {
          ...
          if (System.currentTimeMillis() > expiration) {
            --waiting_threads;
            throw new Semaphore.Timed_out("Timed out waiting to dequeue " + "from Blocking_queue");
          }
  ...
  public synchronized final Object dequeue() throws InterruptedException, Closed, Semaphore.Timed_out {
  ...
  public static final class Test {
    static Blocking_queue queue = new Blocking_queue();
