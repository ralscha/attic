...
public class I15dPanelBuilder extends PanelBuilder {
     ...
     * @param layout	the <code>FormLayout</code> used to layout the
     * container
     ...
     */
    public final void addI15dLabel(String resourceKey, CellConstraints constraints) {
        addLabel(getI15dString(resourceKey), constraints);
    }
     ...
     */
    public final void addI15dLabel(String resourceKey, String encodedConstraints) {
        addI15dLabel(resourceKey, new CellConstraints(encodedConstraints));
    }
     ...
     */
    public final void addI15dSeparator(String resourceKey, CellConstraints constraints) {
        addSeparator(getI15dString(resourceKey), constraints);
    }
     ...
     * @param encodedConstraints  a string representation for the constraints
     */
    public final void addI15dSeparator(String resourceKey, String encodedConstraints) {
        addI15dSeparator(resourceKey, new CellConstraints(encodedConstraints));
    }
     ...
     * @param constraints  the separator's cell constraints
     */
    public final void addI15dTitle(String resourceKey, CellConstraints constraints) {
        addTitle(getI15dString(resourceKey), constraints);
    }
     ...
     * @param encodedConstraints  a string representation for the constraints
     */
    public final void add15dTitle(String resourceKey, String encodedConstraints) {
        addI15dTitle(resourceKey, new CellConstraints(encodedConstraints));
    }
