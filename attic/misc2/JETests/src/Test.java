...
public class Test {
  ...
  public static void main(String[] args) {
    try {
      ...
      session.logon("TNET", "192.168.20.44", "sr", "mexiko", "Ralph Schär", "192.168.20.44");
 
      JebContactFolder jcf = (JebContactFolder)session.getDefaultContactFolder();
      ...
      while ((next = msgs.getNext()) != null) { 
        ...
        if (notEmpty(contact.getFirstName())) {
          pw.println("    <attribut name=\"firstName\">"+contact.getFirstName()+"</attribut>");  
        }
        if (notEmpty(contact.getMiddleName())) {
          pw.println("    <attribut name=\"middleName\">"+contact.getMiddleName()+"</attribut>");
        }
        if (notEmpty(contact.getLastName())) {
          pw.println("    <attribut name=\"lastName\">"+contact.getLastName()+"</attribut>");          
        }
        if (notEmpty(contact.getEmail())) {
          pw.println("    <attribut name=\"email\">"+contact.getEmail()+"</attribut>");          
        }
        if (notEmpty(contact.getBusinessNumber())) {
          pw.println("    <attribut name=\"businessNumber\">"+contact.getBusinessNumber()+"</attribut>");
        }
        if (notEmpty(contact.getHomeNumber())) {
          pw.println("    <attribut name=\"homeNumber\">"+contact.getHomeNumber()+"</attribut>");      
        }
