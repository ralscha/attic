/**
 * Class FirmLiabilityTest.java 
 * 
 * This program is a front-end tool to modify the 'firm_liability' 
...
public class FirmLiabilityTest {
	...
	private static void insert(com.twolink.dbgen.support.Driver driver, String args[])
	  throws SQLException
	{
	  FirmLiability obj = new FirmLiability(Integer.parseInt(args[1]), Integer.parseInt(args[2]), args[3], parseDouble(args[4]), args[5], args[6], args[7], args[8], java.sql.Date.valueOf(args[9]), parseDouble(args[10]), args[11], args[12], args[13], args[14], args[15]);
	  driver.insert(obj);
	}
	...
	private static void delete(com.twolink.dbgen.support.Driver driver, String args[])
	  throws SQLException
	{
	  FirmLiability obj = new FirmLiability(Integer.parseInt(args[1]));
	  driver.delete(obj);
	}
