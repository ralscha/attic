...
public class SWIFTtosnServlet extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            shObj = headerDriver.retrieve(TOSN);

            if (shObj != null)
            {
                out.println("<br>");
                out.println("<FONT SIZE=\"+2\"><B>TOSN "+TOSN+"</B></FONT>");
                out.println("<p>");
                out.println("<FONT SIZE=\"+1\">Message type "+shObj.getMessage_Type()+"</FONT>");
                out.println("<p>");
                ...
                out.println("	<TD>&nbsp;</TD>");
                out.println("	<TD>Dispatch date</TD>");
                ...
                out.println("	<TD>&nbsp;</TD>");
                out.println("	<TD>Receipt date</TD>");

                out.println("	<TD><B>"+shObj.getReceive_Date()+" &nbsp;"+shObj.getReceive_Time()+"</B></TD>");
                out.println("</TR>");
                ...
                ResultSet rs = linesDriver.query(TOSN);
                while ((slObj = linesDriver.next(rs)) != null)
                {
                    line.setLength(0);
                    fTag = slObj.getField_Tag();
                    if (fTag.length() != 0)
                    {
                        line.append(fTag);
                        if (fTag.length() == 2)
        ...
        throws ServletException
    {
        ...
        System.out.println("INIT: SWIFTtosnServlet");
    ...
    public void destroy()
    {
        ...
        System.out.println("DESTROY: SWIFTtosnServlet");
