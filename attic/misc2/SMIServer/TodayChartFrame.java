...
public class TodayChartFrame extends Frame  implements SMIServerListener
{
    ...
    {
          String lastStr = smievent.getLast();
          String updateStr = smievent.getTime();
          ...
          String lowStr = smievent.getLow();
          String highStr = smievent.getHigh();
