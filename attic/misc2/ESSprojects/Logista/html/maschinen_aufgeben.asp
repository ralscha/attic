...
<!-- #include file="include/maschinen/insertmaschine.inc" -->

<HTML>
<HEAD>
<TITLE>Maschinen aufgeben</TITLE>
...
<TABLE border="0" cellpadding="10" cellspacing="0" width="600" bgcolor="#FFFFFF">
	...
	<TR>
		...
		<TD>	
			...
			<FORM name="mail" method="POST" action="maschinen_aufgeben.asp" onSubmit="return chkFM(this)">
				<TABLE border="0">
					<TR>
						<TD colspan="2">
							<TABLE border="0">
						...
						<TD>
							<SELECT name="rubrik" size="1">
							  <% do until MaschinenRubrikRS.eof %>
								<OPTION value="<%=MaschinenRubrikRS("ID")%>"><%= MaschinenRubrikRS("Beschreibung")%></OPTION>
							  <% 
