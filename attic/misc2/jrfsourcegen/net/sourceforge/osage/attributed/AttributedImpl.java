...
/**
 *
 * This class implements a simple idea for a mechanism for holding attributes
 * from Chapter 4 of The Java Programming Language
 * by Ken Arnold and James Gosling.
 *
 * @author <a href="georgestewartiv@yahoo.com">George Stewart</a>
 * @author <a href="rschaer@datacomm.ch">Ralph Schaer</a>
 */

public class AttributedImpl implements Attributed {

  protected Map attrs = Collections.synchronizedMap(new HashMap());
