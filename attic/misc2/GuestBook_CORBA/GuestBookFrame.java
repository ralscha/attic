...
public class GuestBookFrame extends JFrame {
	...
	public GuestBookFrame(boolean applet, IGuestBook gb, org.omg.CORBA.ORB orb) {
        ...
        //Table        
        tableModel = new EntryTableModel(gb, orb);
        ...
        } catch (NoSuchMethodError nosuch) {
            for (int i = 0; i < tableModel.getColumnCount(); i++) {   
                TableColumn col = entryTable.getColumn(tableModel.getColumnName(i));            
                col.setWidth(tableModel.getWidth(i));
            }
        }
