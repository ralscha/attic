...
abstract public class CoordinatorHelper {
  ...
  private static MultiCoordinator.Coordinator narrow(org.omg.CORBA.Object object, boolean is_a) {
    ...
    if(is_a || object._is_a(id())) {
      MultiCoordinator._st_Coordinator result = (MultiCoordinator._st_Coordinator)new MultiCoordinator._st_Coordinator();
      ...
      ((org.omg.CORBA.portable.ObjectImpl) result._this())._set_delegate
        (((org.omg.CORBA.portable.ObjectImpl) object)._get_delegate());
      return (MultiCoordinator.Coordinator) result._this();
    }
    return null;
  }
