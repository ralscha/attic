...
<p>
<ul>
<li> <b>Java Class</b> CounterPortable._CountImplBase
<li> <b>Source File</b> CounterPortable/_CountImplBase.java
...
*/
abstract public class _CountImplBase extends org.omg.CORBA.portable.Skeleton implements CounterPortable.Count {
  ...
  public boolean _execute(org.omg.CORBA.portable.MethodPointer method, org.omg.CORBA.portable.InputStream input, org.omg.CORBA.portable.OutputStream output) {
    ...
    case 0: {
      return CounterPortable._CountImplBase._execute(this, method.method_id, input, output); 
    }
    }
    throw new org.omg.CORBA.MARSHAL();
  }
  public static boolean _execute(CounterPortable.Count _self, int _method_id, org.omg.CORBA.portable.InputStream _input, org.omg.CORBA.portable.OutputStream _output) {
    switch(_method_id) {
    case 0: {
