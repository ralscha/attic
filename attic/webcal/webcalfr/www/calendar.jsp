...
<html>
<head><title>S&eacute;lection de Date</title><meta http-equiv="pragma" content="no-cache"></head>
...
<tr>
<td align="center"><font face="Arial,Helvetica,sans-serif" size="-1"><a href="#" onClick="setOpenerDate(<%= today.get(Calendar.DAY_OF_MONTH)%>,<%= today.get(Calendar.MONTH)%>,<%= today.get(Calendar.YEAR)%>)">Aujourd'hui</a>: <%= dateFormat.format(today.getTime()) %></font></td>
</tr>
</table>
