...
<td><a href="summary.jsp?month=<%= summary.getPrevMonth() %>&year=<%= summary.getPrevYear() %>" class="text">&lt; Mois précédent</a></td>
<td>&nbsp;</td>
<td><a href="summary.jsp?month=<%= summary.getNextMonth() %>&year=<%= summary.getNextYear() %>" class="text">Mois suivant &gt;</a></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td class="text">Mois: <select name="month" size="1">
    <% for (int i = 0; i < 12; i++) {
...
<td class="text">Année : <select name="year">
...
<td><input class="text" type="submit" value="Afficher"></td>	
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
								<td><a href="summary.jsp">Mois courant</a></td>
							</tr>
</table>
</form>
<hr size="1">
