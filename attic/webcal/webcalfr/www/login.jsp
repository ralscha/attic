...
<p align="center" class="titlesmall">Entrée ESS Web Calendar</p>
...
<tr bgcolor="#CFE7E7">
<td colspan="2" align="center"><INPUT type="submit" value="Entrer" name="Login"></td>
</tr>

<% if (login.getUserid() != null) { %>
<tr><td colspan="2">&nbsp;</td></tr>
<tr bgcolor="Red"><td  colspan="2" align="center" class="textb">Echec</td></tr>
<% } %>
