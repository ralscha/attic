...
<p class="titlesmall">Semaine <%= weekrequest.getWeekno() %>:&nbsp;<%= weekrequest.getFormatedDate(0) %>&nbsp;-&nbsp;<%= weekrequest.getFormatedDate(6) %>&nbsp;(<%= weekrequest.getNameString() %>)</p>
...
%>
<tr><td><a href="dv.jsp?userid=<%= request.getParameter("userid") %>&day=<%= day %>&month=<%=request.getParameter("month")%>&year=<%=request.getParameter("year")%>">Voir journée</a></td></tr>
<tr><td bgcolor="#D0D0D0">Voir semaine</td></tr>
</table>
</td>
