...
<title>ESS Web Calendar: Vue journali&egrave;re</title>	
...
<% } %>
    ...
    <td width="55" align="center" valign="top" bgcolor="#D0D0D0"><a href="d.jsp?onedate=<%= dayrequest.getFormatedDate() %>" class="textb">Journée entière</a></td>	
    <% } else { %>
	<td width="55" align="center" valign="top" bgcolor="#D0D0D0" class="textb">Journée entière</td>
	<% } %>
...
<p>
<table>
<tr><td bgcolor="#D0D0D0">Voir journée</td></tr>
<% 
   String day = request.getParameter("day");
   if (day == null)
     day = dayrequest.getDay();
%>
<tr><td><a href="weekview.jsp?userid=<%= request.getParameter("userid") %>&day=<%= day %>&month=<%=request.getParameter("month")%>&year=<%=request.getParameter("year")%>">Voir semaine</a></td></tr>
</table>
</td>
