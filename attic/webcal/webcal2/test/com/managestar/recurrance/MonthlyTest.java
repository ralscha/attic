...
public class MonthlyTest extends AbstractTestCase {
  ...
  public void testMonthly() {
    ...
    String rule = VCalRuleParser.getICalRule("MD2 26 #5");
    testRule(rule,
             new String[] {
               "Wed Jun 26 19:54:40 GMT 2002",
               "Mon Aug 26 19:54:40 GMT 2002",
    ...
    rule = VCalRuleParser.getICalRule("MD2 26 20030226");             
    testRule(rule,
             new String[] {
               "Wed Jun 26 19:54:40 GMT 2002",
               "Mon Aug 26 19:54:40 GMT 2002",
    ...
    rule = VCalRuleParser.getICalRule("MD2 26 20030225");
    testRule(rule,
             new String[] {
               "Wed Jun 26 19:54:40 GMT 2002",
               "Mon Aug 26 19:54:40 GMT 2002",
    ...
    rule = VCalRuleParser.getICalRule("MD2 26 20020626");
    testRule(rule,
             new String[] {
               "Wed Jun 26 19:54:40 GMT 2002",
             });  
    ...
    rule = VCalRuleParser.getICalRule("MD2 26 20020225");             
    testRule(rule,
             new String[] {
             });  
    ...
    rule = VCalRuleParser.getICalRule("MD2 26 20030226T195440Z");
    testRule(rule,
             new String[] {
               "Wed Jun 26 19:54:40 GMT 2002",
               "Mon Aug 26 19:54:40 GMT 2002",
    ...
    rule = VCalRuleParser.getICalRule("MD2 26 20030226T195439Z");
    testRule(rule,
             new String[] {
               "Wed Jun 26 19:54:40 GMT 2002",
               "Mon Aug 26 19:54:40 GMT 2002",
    ...
    rule = VCalRuleParser.getICalRule("MD2 26 20020626T195440Z");             
    testRule(rule,
             new String[] {
               "Wed Jun 26 19:54:40 GMT 2002"
             });      
    ...
    rule = VCalRuleParser.getICalRule("MD2 26 20020626T195441Z");
    testRule(rule,
             new String[] {
               "Wed Jun 26 19:54:40 GMT 2002"
             });
    ...
    rule = VCalRuleParser.getICalRule("MD2 26 20020626T195439Z");             
    testRule(rule,
             new String[] {               
             });      
    ...
    testRule("FREQ=MONTHLY;COUNT=5;INTERVAL=2;BYYEARDAY=122",
             new String[] {
               "Fri May 02 21:54:40 GMT+02:00 2003",
               "Sat May 01 21:54:40 GMT+02:00 2004",
               "Mon May 02 21:54:40 GMT+02:00 2005",
               "Tue May 02 21:54:40 GMT+02:00 2006",
               "Wed May 02 21:54:40 GMT+02:00 2007"
             });   
    ...
    rule = VCalRuleParser.getICalRule("MD1 3- #10");             
    testRule(rule,
             new String[] {
               "Fri Jun 28 19:54:40 GMT 2002",
               "Mon Jul 29 19:54:40 GMT 2002",
    ...
    rule = VCalRuleParser.getICalRule("MD18 10 11 12 13 14 #10");
    testRule(rule,
             new String[] {
               "Wed Dec 10 19:54:40 GMT 2003",
               "Thu Dec 11 19:54:40 GMT 2003",
    ...
    rule = VCalRuleParser.getICalRule("MD1 26");
    ...
    testRule("FREQ=MONTHLY;BYDAY=TU,WE,TH;BYSETPOS=1,-1",
             new String[] {
                "Wed Jun 26 21:54:40 GMT+02:00 2002",
                "Thu Jun 27 21:54:40 GMT+02:00 2002",
                "Tue Jul 02 21:54:40 GMT+02:00 2002",
                "Wed Jul 31 21:54:40 GMT+02:00 2002",
                "Thu Aug 01 21:54:40 GMT+02:00 2002",
