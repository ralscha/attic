...
import ch.ess.cal.db.UserConfiguration;
...
public final class UserConfig extends Config {
  ...
  public static final String OVERVIEW_PIC_WIDTH = "overview.pic.width";
  public static final String OVERVIEW_PIC_HEIGHT = "overview.pic.height";
  ...
  protected void load() throws HibernateException {
    ...
    if (isEmpty()) {
      ...
      storeProperty(FIRST_DAY_OF_WEEK, Calendar.MONDAY);
