...
public class GroupEmailFormListControl extends AbstractFormListControl<Group, Email> {
  ...
  @Override
  protected Email newModelItem(DynaBean dynaBean, Group group, Map<String, Object> parameters) {
    Boolean def = (Boolean)dynaBean.get("default");
