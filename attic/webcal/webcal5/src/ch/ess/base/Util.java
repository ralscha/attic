...
public class Util {
  ...
  public static String translate(final HttpServletRequest request, final String key, final Object... args) {
    return getMessages(request).getMessage(getLocale(request), key, args);
  }
}
