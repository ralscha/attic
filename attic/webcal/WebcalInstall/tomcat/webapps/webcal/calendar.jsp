...
<tr>
<td align="center"><font face="Arial,Helvetica,sans-serif" size="-1"><a href="calendar.jsp?form=<%=request.getParameter("form")%>&elem=<%=request.getParameter("elem")%>&m=<%= today.get(Calendar.MONTH) %>&y=<%= today.get(Calendar.YEAR) %>">Today</a>: <%= dateFormat.format(today.getTime()) %></font></td>
</tr>
</table>
