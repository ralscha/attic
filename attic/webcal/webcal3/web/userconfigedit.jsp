...
<html>
  ...
  <body>	
    ...
    <misc:initSelectOptions id="timeOption" type="ch.ess.cal.web.options.TimeOptions" scope="session" />
    <misc:initSelectOptions id="timezoneOption" type="ch.ess.cal.web.options.TimezoneOptions" scope="application" />
    <misc:initSelectOptions id="localeOption" name="localeOptions" scope="application" />
    <misc:initSelectOptions id="weekStartOption" type="ch.ess.cal.web.options.WeekStartOptions" scope="session" />
