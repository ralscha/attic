...
public class HolidayForm extends AbstractForm {
  ...
  /**   
   * @struts.validator type="validwhen,integer,positive"
   * @struts.validator-arg position="0" key="holiday.monthNo"
   * @struts.validator-var name="test" value="((builtin != null) or (*this* != null))"
   */
  ...
  /**   
   * @struts.validator type="validwhen,integer,positive"
   * @struts.validator-arg position="0" key="holiday.dayOfMonth"
   * @struts.validator-var name="test" value="((builtin != null) or (*this* != null))"
   */
