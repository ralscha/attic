...
public class UsersTable {
	...
	private final static String selectSQL = "SELECT userid,firstname,name,password,administrator FROM Users";
	private final static String orderSQL  = " ORDER BY ";

	private int limit;

	private final static String insertSQL = 
		"INSERT INTO Users(userid,firstname,name,password,administrator) VALUES(?,?,?,?,?)";

	private final static String updateSQL = 
		"UPDATE Users SET firstname=?, name=?, password=?, administrator=? WHERE userid=?";
