...
public class UsersTable {
	...
	private final static String selectSQL = "SELECT userid,firstname,name,passwort,administrator FROM Users";
	private final static String orderSQL  = " ORDER BY ";

	private int limit;

	private final static String insertSQL = 
		"INSERT INTO Users(userid,firstname,name,passwort,administrator) VALUES(?,?,?,?,?)";

	private final static String updateSQL = 
		"UPDATE Users SET firstname=?, name=?, passwort=?, administrator=? WHERE userid=?";
  ...
  public Iterator select(String whereClause, String orderClause) throws SQLException {
	...
	private void prepareUpdateStatement(PreparedStatement ps, Users users) throws SQLException {
		...
		ps.setString(5, users.getUserid());
	}
}
