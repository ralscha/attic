...
<td rowspan="<%= categoriesMap.getSize() %>" align="center"><input type="submit" name="update" value="Update"><input type="hidden" name="hi<%= cat.getCategoryid() %>" value="<%= cat.getColor() %>.gif"></td>
...
<td><input type="text" name="cat<%= cat.getCategoryid() %>" value="<%= cat.getDescription()%>" size="20" maxlength="50"></td>
<td align="center"><a href="javascript:calcolorchooser('colorchooser.jsp?img=<%= imgcount %>&form=<%= formno %>&hi=hi<%= cat.getCategoryid() %>')"><img src="images/full/<%= cat.getColor() %>.gif" border="0" alt=""></a></td>
<td align="center"><a href="categoriesmanagement.jsp?delete=<%= cat.getCategoryid() %>">Delete</a><input type="hidden" name="hi<%= cat.getCategoryid() %>" value="<%= cat.getColor() %>.gif"></td>
...
<td colspan="2" align="center"><input type="submit" name="add" value="Add"><input type="hidden" name="hinew" value=""></td>
