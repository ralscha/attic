...
public class UsersTable {
	...
	private final static String selectSQL = "SELECT userid,firstname,name,passwort,administrator,email FROM Users";
	private final static String orderSQL  = " ORDER BY ";

	private int limit;

	private final static String insertSQL = 
		"INSERT INTO Users(userid,firstname,name,passwort,administrator,email) VALUES(?,?,?,?,?,?)";

	private final static String updateSQL = 
		"UPDATE Users SET firstname=?, name=?, passwort=?, administrator=?, email=? WHERE userid=?";
