...
<tr>
<td rowspan="3" bgcolor="#F0F0F0"><p class="summarytitle"><%= summary.getRequestMonthName() %>&nbsp;<%= summary.getYear() %></p></td>
<%
...
<tr>
<%
  for (int i = 0; i < summary.getWeekNos().size(); i++) {
    Integer wnr = (Integer)summary.getWeekNos().get(i);
    Integer colspan = (Integer)summary.getWeekColspan().get(i);    
%>   
    <td align="center" class="textsmall" colspan="<%= colspan %>"><%= wnr %></td>
<%  } 
