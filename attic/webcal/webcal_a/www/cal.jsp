...
// -->
	...
	<a href="<%= link %>userid=<%= userid %>&day=<%= today.get(Calendar.DAY_OF_MONTH)%>&month=<%= today.get(Calendar.MONTH)%>&year=<%= today.get(Calendar.YEAR)%>" class="day">Today: <%= ch.ess.calendar.util.Constants.dateFormat.format(today.getTime()) %></a>
