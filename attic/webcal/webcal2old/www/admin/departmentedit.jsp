...
<html:form focus="name" action="/storeDepartment.do" method="post" onsubmit="return validateDepartmentForm(this);">
...
<tr>
 <td valign="top" class="optionalInput"><bean:message key="EMail"/>:&nbsp;</td>
