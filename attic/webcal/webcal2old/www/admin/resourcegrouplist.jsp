...
<misc:confirm key="DeleteResourceGroup"/>
<html:form action="/listResourceGroup.do" method="post">
...
<display:table width="760" name="result" scope="session" pagesize="10" requestURI="resourceGroup.do" decorator="ch.ess.cal.admin.web.resourcegroup.ResourceGroupDecorator">
...
<html:link page="/editResourceGroup.do?action=add" styleClass="action"><bean:message key="New"/></html:link>
<p>&nbsp;</p>
