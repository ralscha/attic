...
<html:form focus="name" action="/storeResourceGroup.do" method="post" onsubmit="return validateResourceGroupForm(this);">
...
<html:javascript formName="resourceGroupForm"
