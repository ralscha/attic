...
public class YearlyTest extends AbstractTestCase {
  ...
  public void testYearly() {
    ...
    String rule = VCalRuleParser.getICalRule("YM1 6");
    ...
    rule = VCalRuleParser.getICalRule("YM1 6 #0");
    ...
    rule = VCalRuleParser.getICalRule("YM1 6 20060626");
    testRule(rule,
                 new String[] {
                   "Wed Jun 26 19:54:40 GMT 2002",
                   "Thu Jun 26 19:54:40 GMT 2003",
    ...
    rule = VCalRuleParser.getICalRule("YM1 6 20060625");
    ...
    rule = VCalRuleParser.getICalRule("YM1 6 20020627");
    ...
    rule = VCalRuleParser.getICalRule("YM1 6 20060626T195440Z");
    ...
    rule = VCalRuleParser.getICalRule("YM1 6 20060626T195439Z");             
    ...
    rule = VCalRuleParser.getICalRule("YM1 6 20020627T195440Z");    
    ...
    rule = VCalRuleParser.getICalRule("YM1 6");    
    ...
    rule = VCalRuleParser.getICalRule("YM2 6");
    ...
    rule = VCalRuleParser.getICalRule("YM1 6 #1");             
    ...
    rule = VCalRuleParser.getICalRule("YM1 6 #2");             
    ...
    rule = VCalRuleParser.getICalRule("YM2 6 #1");
    ...
    rule = VCalRuleParser.getICalRule("YM2 6 #3");             
    ...
    rule = VCalRuleParser.getICalRule("YM1 1 3 5 #5");             
    ...
    rule = VCalRuleParser.getICalRule("YD1 1 130 #5");             
    ...
    testRule("FREQ=YEARLY;BYDAY=MO,TU,WE,TH,FR;BYSETPOS=-2",
             new String[] {
               "Mon Dec 30 20:54:40 GMT+01:00 2002",
               "Tue Dec 30 20:54:40 GMT+01:00 2003",
               "Thu Dec 30 20:54:40 GMT+01:00 2004",
               "Thu Dec 29 20:54:40 GMT+01:00 2005",
               "Thu Dec 28 20:54:40 GMT+01:00 2006",
