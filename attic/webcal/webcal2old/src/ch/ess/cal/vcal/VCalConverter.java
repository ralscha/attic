...
public class VCalConverter {
  ...
  public static void toDatabase(Session sess, CalUser user, VCalendar calendar) throws HibernateException, ParseException {
    ...
    for (Iterator it = events.iterator(); it.hasNext();) {
      ...
      User dbUser = (User)sess.load(User.class, user.getUserId());
      userSet.add(dbUser);
      ...
      if (f != null) {
        Calendar cal = Util.convertToUTCCalendar(f.getFieldValue(), user.getTimezone());
