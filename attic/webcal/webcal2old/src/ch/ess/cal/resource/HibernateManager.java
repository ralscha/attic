 ...
 *
 * @author Ted Husted
 * @version $Revision: 1.7 $ $Date: 2003/05/07 14:06:16 $
 */
public class HibernateManager {
  ...
  static {
    ...
    classList.add(Event.class);    
    //classList.add(EventProperty.class);
    classList.add(Attachment.class);
    classList.add(Category.class);
    classList.add(Configuration.class);
    classList.add(Department.class);
    classList.add(DepartmentConfiguration.class);
    classList.add(Email.class);
    classList.add(Holiday.class);
    classList.add(Permission.class);
    classList.add(Recurrence.class);
    classList.add(Reminder.class);
    classList.add(Resource.class);
    classList.add(ResourceGroup.class);
    classList.add(User.class);
    classList.add(UserGroup.class); 
    classList.add(UserConfiguration.class); 
   ...
   */
  public static final net.sf.hibernate.cfg.Configuration createConfiguration() throws MappingException {
    net.sf.hibernate.cfg.Configuration conf = new net.sf.hibernate.cfg.Configuration();
    if (classList != null) {
  ...
  public static void exceptionHandling(Transaction tx) {
    if (tx != null) {
      try {
        tx.rollback();
  ...
  //Utility methods
  public static void deleteCollection(Session sess, Collection coll) 
                    throws HibernateException {
