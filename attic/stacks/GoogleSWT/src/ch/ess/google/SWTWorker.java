 ...
 */
public abstract class SWTWorker extends ThreadFactoryUser implements Runnable {
   ...
   * for no time limit.
   */
  protected SWTWorker(ThreadFactory factory, long msecs) {
  ...
  public void run() {
    ...
    Display.getDefault().asyncExec(doFinished);
  }
