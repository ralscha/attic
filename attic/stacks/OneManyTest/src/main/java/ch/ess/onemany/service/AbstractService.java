...
import ch.ess.onemany.entity.AbstractEntity;
...
public abstract class AbstractService<T extends AbstractEntity> {
  ...
  public AbstractService(final Class<T> persistentClass) {
  ...
  @Transactional
  public void update(final T baseObject) {
    getSession().update(baseObject);
  }
  ...
  @SuppressWarnings("unchecked")
  @Transactional
  public T merge(final T baseObject) {
    return (T)getSession().merge(baseObject);
  }
