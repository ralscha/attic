...
import ch.ess.ex4u.client.data.NavigationData;
...
public class SideNavTree extends TreeGrid {
  ...
  private NavigationTreeNode[] navigationData = NavigationData.getData(idSuffix);
  ...
  public NavigationTreeNode[] getNavigationData() {
