...
@Entity
@Table(name="punkte")
public class Punkte implements Serializable {
  ...
  @ManyToOne
  @JoinColumn(name = "spielId", nullable = false)
  private Spiel spiel;
  
  @ManyToOne
  @JoinColumn(name = "spielerId", nullable = false)
  ...
  public boolean equals(final Object obj) {
    if (!(obj instanceof Punkte)) {
      return false;
    }

    Punkte other = (Punkte)obj;
