...
@Controller
public class RangpunkteController {
  ...
  @RequestMapping(value="/rangpunkteList.do", method = RequestMethod.GET)
  public String processGet(@ModelAttribute("command") FormInput formInput, ModelMap modelMap) {       
    ...
    modelMap.addAttribute("rangpunkte", reportService.getRangpunkte(club, formInput.getJahr()));    
    return "rangpunkte.jsp";
  }
  
  
  @RequestMapping(value="/rangpunkteList.do", method = RequestMethod.POST)
  ...
  @RequestMapping("/rangpunkteListDL.do")
