...
/** 
  * @author  Ralph Schaer
  * @version $Revision: 1.7 $ $Date: 2003/11/12 03:42:19 $
  *  
...
public class ConfigForm extends ValidatorForm {
   ...
   * @struts.validator-args arg0resource="config.errorMailReceiver"
   */
  ...
  /**   
   * @struts.validator type="required,email"
   * @struts.validator-args arg0resource="config.defaultMailSender"
   */
   ...
   * @struts.validator-args arg0resource="config.mailSmtp"
   */
   ...
   * @struts.validator-args arg0resource="config.passwordLen"
   */
  ...
  /**   
   * @struts.validator type="required"
   * @struts.validator-args arg0resource="config.uploadPath"
   */
  ...
  /**   
   * @struts.validator type="required,integer"
   * @struts.validator-args arg0resource="config.sessionTimeout"
   */
  ...
  /**   
   * @struts.validator type="required,integer"
   * @struts.validator-args arg0resource="config.mailSmtpPort"
   */
