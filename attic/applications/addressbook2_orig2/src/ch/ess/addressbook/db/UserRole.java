...
/** A business entity class representing a UserRole
  * 
  * @author  Ralph Schaer
  * @version $Revision: 1.5 $ $Date: 2003/11/11 18:58:37 $   
  * @hibernate.class  table="abUserRole" lazy="true"
  */
...
public class UserRole extends Persistent {
  ...
  */
  ...
  /** 
  * @hibernate.many-to-one class="ch.ess.addressbook.db.Role" column="roleId" not-null="true"
  */
  public Role getRole() {
    return role;
  }
