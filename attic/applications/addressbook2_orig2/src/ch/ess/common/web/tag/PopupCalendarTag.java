...
public class PopupCalendarTag extends VelocityTag {
  ...
  public int doStartTag() throws JspException {
    ...
    try {
      imageURL = TagUtils.getInstance().computeURL(pageContext, null, null, "/images/calendar.gif", null, null, null, true);
      imagepURL = TagUtils.getInstance().computeURL(pageContext, null, null, "/images/calendar_p.gif", null, null, null, true);
    ...
    context.put("calendargifdown", imagepURL);
    if (past) {
      context.put("past", "1");
    } else {
      context.put("past", "0");
