...
public class MailMessage {
  ...
  //TO Addresses
  public void addTo(String address, String personal) throws AddressException, UnsupportedEncodingException {
    toList = addAddress(toList, address, personal);
  }

  public void addTo(String address) throws AddressException, UnsupportedEncodingException {
  ...
  //CC Addresses
  public void addCC(String address, String personal) throws AddressException, UnsupportedEncodingException {
    ccList = addAddress(ccList, address, personal);
  }

  public void addCC(String address) throws AddressException, UnsupportedEncodingException {
  ...
  //BCC Addresses
  public void addBCC(String address, String personal) throws AddressException, UnsupportedEncodingException {
    bccList = addAddress(bccList, address, personal);
  }

  public void addBCC(String address) throws AddressException, UnsupportedEncodingException {
  ...
  //From Addresses
  public void addFrom(String address, String personal) throws AddressException, UnsupportedEncodingException {
    fromList = addAddress(fromList, address, personal);
  }

  public void addFrom(String address) throws AddressException, UnsupportedEncodingException {
  ...
  //Reply To Addresses
  public void addReplyTo(String address, String personal) throws AddressException, UnsupportedEncodingException {
    replyToList = addAddress(replyToList, address, personal);
  }

  public void addReplyTo(String address) throws AddressException, UnsupportedEncodingException {
  ...
  private List addAddress(List list, String email) throws AddressException, UnsupportedEncodingException {
    return addAddress(list, email, null);
  }
  
  private List addAddress(List list, String email, String personal) throws AddressException, UnsupportedEncodingException {
