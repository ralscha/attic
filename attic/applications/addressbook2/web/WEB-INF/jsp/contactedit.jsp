...
<script language="JavaScript" src="<c:url value='/scripts/window.js' />" type="text/javascript"></script>
...
<br />
	...
	<DIV id="p1" style="background-color: transparent; position: relative; width: 450px; height: 350px">
		<DIV id="p1panel0" class="panel" style="background-color: #EEEEEE;  z-index:5; width: 450px; height: 350px">	
	       <table width="400">
			<tr>
				<td width="144">
		...
		<DIV onClick="selectTab(0)" id="p1tab0" class="tab" style="background-color:#EEEEEE; left:0px; top:0px; z-index:5; clip:rect(0 auto 25 0)"><bean:message key="Allgemein"/>
		</DIV>
		<DIV id="p1panel1" class="panel" style="background-color: #EEEEEE;  z-index:4; width: 450px; height: 350px">
		  <table width="400">
			<tr>
				<td>
		...
		<DIV onClick="selectTab(1)" id="p1tab1" class="tab" style="background-color:#EEEEEE; left:90px; top:0px; z-index:4; clip:rect(0 auto 25 0)">
<bean:message key="Business"/>
		</DIV>
		<DIV id="p1panel2" class="panel" style="background-color: #EEEEEE;  z-index:3; width: 450px; height: 350px">
		<table width="400">
			<tr>
				<td width="144">
		...
		<DIV onClick="selectTab(2)" id="p1tab2" class="tab" style="background-color:#EEEEEE; left:180px; top:0px; z-index:3; clip:rect(0 auto 25 0)">
<bean:message key="Home"/>
		</DIV>
		<DIV id="p1panel3" class="panel" style="background-color: #EEEEEE;  z-index:2; width: 450px; height: 350px">
		   <table width="400">
			<tr>
				<td width="144">
		...
		<DIV onClick="selectTab(3)" id="p1tab3" class="tab" style="background-color:#EEEEEE; left:270px; top:0px; z-index:2; clip:rect(0 auto 25 0)">
<bean:message key="Other"/>
		</DIV>
	
		<DIV id="p1panel4" class="panel" style="background-color: #EEEEEE;  z-index:1; width: 450px; height: 350px">
		   <table width="400">
			<tr>
				<td width="144">
			...
			<a href="javascript:newWindow('<c:url value="/showPicture.donogz"/>','<bean:message key="Foto"/>', <bean:write name="contactForm" property="value(originalWidth)"/>, <bean:write name="contactForm" property="value(originalHeight)"/>, false)"><img src="<c:url value='/showPicture.donogz'/>" alt="" width="<bean:write name='contactForm' property='value(width)'/>" height="<bean:write name="contactForm" property="value(height)"/>" border="0"></a>
			<br>
			<bean:message key="loeschenFrage"/><html:checkbox property="deletePicture"/>
			</logic:notEmpty>
			</td></tr>
			</table>
	
		</DIV>
		<DIV onClick="selectTab(4)" id="p1tab4" class="tab" style="background-color:#EEEEEE; left:360px; top:0px; z-index:1; clip:rect(0 auto 25 0)">
...
<c:if test="${not empty contactForm.id}">
<input type="submit" onclick="return confirmRequest('<bean:write name="contactForm" property="value(lastName)"/>')" name="delete" value="<bean:message key="common.delete"/>" />&nbsp;
</c:if>
<html:cancel><bean:message key="Back"/></html:cancel>
</html:form>
<html:javascript cdata="false" formName="contactForm"
