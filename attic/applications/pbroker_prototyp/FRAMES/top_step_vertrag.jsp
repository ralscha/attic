...
<%! String[] alt = {"Uebersicht Anfragen", "Detail Anfrage"} ; %>

<html><head><title>Offerten</title></head>
<body background="images/setp_bg.gif">
<table border="0" cellpadding="0" cellspacing="0">
<tr><td>&nbsp;</td><td><b><font color="#FFFFFF" face="Verdana,Arial,Helvetica,sans-serif" size="2">
STEP NAVIGATOR: Vertrags&auml;nderung</font></b></td></tr><tr><td><img border="0" src="images/x.gif" width="439" height="39"></td>
<td nowrap>
