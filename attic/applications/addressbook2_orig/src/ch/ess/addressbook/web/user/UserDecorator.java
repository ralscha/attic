...
public class UserDecorator extends TableDecorator {
    ...
    public String getEdit() throws MalformedURLException {
      ...
      String editURL =
        TagUtils.getInstance().computeURL(getPageContext(), null, null, "/editUser.do", null, params, null, true);
    ...
    public String getDelete() throws MalformedURLException {
      ...
      params.put("id", id);
      String editURL =
       TagUtils.getInstance().computeURL(getPageContext(), null, null, "/deleteUser.do", null, params, null, true);
