...
public class CategoryCount {
  ...
  public void setCount(String category, int count) {
    if (category != null) {
      categoryCountMap.put(category.toUpperCase(), new Integer(count));
    }
  }
  
  public void inc(String category) {
    if (category != null) {
      Integer count = (Integer)categoryCountMap.get(category.toUpperCase());
      if (count != null) {
        categoryCountMap.put(category.toUpperCase(), new Integer(count.intValue() + 1));
      } else {
        categoryCountMap.put(category.toUpperCase(), new Integer(1));
      }
    }
  }
  ...
  public void dec(String category) {
    if (category != null) {
      ...
      if (count != null) {
        ...
        categoryCountMap.put(category.toUpperCase(), new Integer(c));
      }  
    }
  }
