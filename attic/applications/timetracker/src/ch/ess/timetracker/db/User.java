...
/** A business entity class representing an User
  ...
  * @hibernate.class  table="ttUser" lazy="true"
  */
...
public class User extends Persistent {
  ...
  */
   ...
   * @hibernate.collection-one-to-many  class="ch.ess.timetracker.db.UserConfiguration"
   */
   ...
   * @hibernate.collection-key column="userId"     
   * @hibernate.collection-many-to-many class="ch.ess.timetracker.db.Customer" column="customerId"
   */
