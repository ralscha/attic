...
public final class LoginServlet extends HttpServlet {
      ...
      if (loginCookie != null) {
        ...
        if (user != null) {
          ...
          if (isTokenValid(user, config)) {
            ...
            setSessionObjects(request, user, config);
        ...
        if (request.getParameter("newPassword") != null) {
          ...
          if (user != null) {
            ...
            if (!GenericValidator.isBlankOrNull(remember)) {
              ...
              Cookie newCookie = new Cookie(ch.ess.timetracker.Constants.COOKIE_REMEMBER, user.getLoginToken());
  ...
  private void setSessionObjects(HttpServletRequest request, User user, UserConfig config) throws ServletException {
    ...
    session.setAttribute("static_weekno", new Integer(cal.get(Calendar.WEEK_OF_YEAR)));
    session.setAttribute("static_date", ch.ess.timetracker.Constants.DATE_FORMAT.format(cal.getTime()));
