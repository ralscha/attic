...
/** 
  ...
  */
public class ProjectWithTasksOptions extends Options {
  ...
  public void init() throws HibernateException {
    ...
    try {
      ...
      if (customerId == null) {      
        resultList = HibernateSession.currentSession().find("from Project as p where size(p.tasks) > 0 order by p.name asc");
