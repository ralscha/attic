...
<table class="title" width="100%">
  ...
  <c:if test="${not empty sessionScope.clientinfo.jsVersion}">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="status.date"/>: ${sessionScope.static_date}&nbsp;&nbsp;<bean:message key="status.weekno"/>: ${sessionScope.static_weekno}
	</div>
	</c:if>
    ...
    <td width="20%" align="right">
      <table cellspacing="0" cellpadding="0">
        <tr>
	      <td align="right" class="titlebig"><span class="titlebig"><bean:message key="application.title"/></span>&nbsp;<span class="titlesmall">1.0</span></td>
        </tr>
      </table>
    </td>
