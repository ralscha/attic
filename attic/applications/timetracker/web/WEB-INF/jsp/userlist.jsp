...
<misc:initSelectOptions id="roleOption" type="ch.ess.timetracker.web.RoleOptions" scope="session" />
...
<display:table name="result" export="false" scope="session" pagesize="${sessionScope.static_noRows}" requestURI="${pageScope.requestURI}" sort="list" defaultsort="1" class="list" decorator="ch.ess.timetracker.web.user.UserDecorator">
