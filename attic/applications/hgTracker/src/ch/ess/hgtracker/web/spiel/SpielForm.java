...
public class SpielForm extends ValidatorForm {
  ...
  // primarykey von der ausgewählten art
  private String artId;
  // alle arten fürs dropdown 
  private List<LabelValueBean> art;
  // spielart der ausgewählten art
  ...
  public void reset(ActionMapping mapping, HttpServletRequest request) {
    ries1nr = Boolean.FALSE;
    ries2nr = Boolean.FALSE;
    ries3nr = Boolean.FALSE;
    ries4nr = Boolean.FALSE;
    ries5nr = Boolean.FALSE;
    ries6nr = Boolean.FALSE;
  }
  ...
  public List<LabelValueBean> getArt() {
    return art;
  }

  public void setArt(List<LabelValueBean> art) {
    this.art = art;
  }
