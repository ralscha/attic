/*
 * $Header: c:/cvs/addressbook/src/ch/ess/addressbook/common/ExcelGeneratorHSSF.java,v 1.1 2003/03/31 06:38:35 sr Exp $
 * $Revision: 1.1 $
 * $Date: 2003/03/31 06:38:35 $
 */
  ...
  public void generate(OutputStream out) throws IOException {
    ...
    for (int row = 0; row < rowCount; row++) {
      ...
      for (int i = 0; i < colCount; i++) {
        ...
        if (val == null) {
          c.setCellValue(ch.ess.Constants.BLANK_STRING);
          c.setCellType(HSSFCell.CELL_TYPE_STRING);          
