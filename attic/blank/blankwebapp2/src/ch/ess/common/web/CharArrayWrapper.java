...
public class CharArrayWrapper extends HttpServletResponseWrapper {
   ...
   * one. Instead, give them a version that writes into the character array. The
   * filter needs to send the contents of the array to the client (perhaps after
   * modifying it).
   */
   ...
   * 
   * <p>
   * Be sure <strong>not </strong> to call this method multiple times on the
   * same wrapper. The API for CharArrayWriter does not guarantee that it
   * "remembers" the previous value, so the call is likely to make a new String
   * every time.
   * </p>
   */
