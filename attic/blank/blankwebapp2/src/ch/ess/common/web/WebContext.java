...
public class WebContext {
  ...
  private WebContext(HttpServletRequest req, HttpServletResponse res, ServletContext ctx, ActionMapping map,
      ActionForm f) {
  ...
  public UserSession getUserSession() {
    return (UserSession) getSession().getAttribute(Constants.USER_SESSION);
  }
