...
import ch.ess.blank.resource.InitLog;
 ...
 * 
 * @struts.action path="/storeConfig" name="configForm" input=".config.edit" scope="session" validate="true" parameter="store" roles="systemconfig"
 * @struts.action path="/editConfig" name="configForm" input=".config.edit" scope="session" validate="false" parameter="edit" roles="systemconfig"
