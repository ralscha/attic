 ...
 * 
 * @struts.action path="/listResource" name="mapForm" scope="session" validate="false" roles="textresource"
...
public class ResourceListAction extends HibernateAction {
  ...
  static {
    resultClass = new BasicDynaClass("ResultClassUser", null, new DynaProperty[]{new DynaProperty("id", Long.class),
        new DynaProperty("name", String.class), new DynaProperty("canDelete", Boolean.class)});
