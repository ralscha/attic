...
<c:if test="${userForm.cookieLogin}">
...
<tr>
 <td><misc:label property="lastName" key="user.lastName"/>&nbsp;</td>
...
<misc:initSelectOptions id="localeOption" type="ch.ess.blank.web.LocaleOptions" scope="session" />
<tr>
...
<tr>
 <td valign="top"><misc:label property="userGroupIds" key="user.userGroups"/>&nbsp;</td>
 <td>
   <table>
	<logic:iterate id="uo" name="usergroupOption" property="labelValue" type="org.apache.struts.util.LabelValueBean"> 
	<tr><td><html:multibox property="userGroupIds" value="${uo.value}" /></td><td>${uo.label}</td></tr>
	</logic:iterate>
   </table>   
