...
public class Gui extends JFrame {
  ...
  private static String[] jspOutputFiles = {"${objectAllLowercaseName}list.jsp", "${objectAllLowercaseName}edit.jsp"};
  ...
  void createSource() {
    try {
      ...
      context.put("objectAllLowercaseName", objectLowercaseNameText.getText().toLowerCase());
      ...
      context.put("internal_username", "${" + objectLowercaseNameText.getText() + "Form." + deleteColumnTooltipText.getText()
          + "}");
