 ...
 * 
 * @author  Ralph Schaer
 * @version $Revision: 1.4 $ $Date: 2004/05/22 12:24:36 $ 
 * @hibernate.class  table="blankTextResource"
 */
public class TextResource extends Persistent {
  ...
  /**      
   * @hibernate.map table="blankTextResourceLocale" 
  ...
  public static int delete(Long textResourceId) throws HibernateException {
    return HibernateSession.currentSession().delete("from TextResource as tr where tr.id = ?", textResourceId,
        Hibernate.LONG);
  }
}