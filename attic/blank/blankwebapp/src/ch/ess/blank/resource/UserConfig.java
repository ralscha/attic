...
import ch.ess.blank.db.UserConfiguration;
import ch.ess.blank.web.userconfig.TimeEnum;
import ch.ess.common.db.HibernateSession;

/**
 * @author Ralph Schaer
 * @version $Revision: 1.7 $ $Date: 2004/05/22 12:24:18 $
 */
public final class UserConfig extends Config {
  ...
  public static final String FIRST_DAY_OF_WEEK = "first.day.of.week";
  ...
  public void removeProperty(String key) throws HibernateException {
    ...
    HibernateSession.currentSession().delete("from UserConfiguration as conf where conf.user = ? and conf.name = ?",
  ...
  public void storeProperty(String key, String value) throws HibernateException {
    ...
    List result = HibernateSession.currentSession().find(
        "from UserConfiguration as conf where conf.user = ? and conf.name = ?", new Object[]{userId, key},
  ...
  protected void load() throws HibernateException {
    ...
    List result = HibernateSession.currentSession().find("from UserConfiguration as conf where conf.user = ?", userId,
        Hibernate.LONG);
