 ...
 * 
 * @author Ted Husted
 * @version $Revision: 1.5 $ $Date: 2004/05/22 12:24:38 $
 */
public final class SearchEngine {
  ...
  /**
   * Return default analyzer for application A non-English site should use a
   * different analyzer
   * 
   * @return The default analyzer
   * @exception Throws
   *              ResourceException on IO error
   */
   ...
   * 
   * @param Set
   *          to true to create a new index; usually false.
  ...
  /**
   * Delete record matching term from default index. Access to the index is
   * synchronized.
   * 
   * @param term
   *          The term matching the entry to delete
   * @exception Throws
   *              ResourceException on IO error
   */
