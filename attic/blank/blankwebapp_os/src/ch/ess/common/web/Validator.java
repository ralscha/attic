...
/**
 * @author Ralph Schaer
 * @version $Revision: 1.6 $ $Date: 2004/05/22 12:24:21 $
 */
public class Validator {

  private static Log LOG = LogFactory.getLog(Validator.class);

  public static boolean validateIdentical(Object bean, ValidatorAction va, Field field, ActionMessages errors,
  ...
  public static boolean validateContentType(Object bean, ValidatorAction va, Field field, ActionMessages errors,
      HttpServletRequest request) {
