...
/** 
 * @author  Ralph Schaer
 * @version $Revision: 1.6 $ $Date: 2004/05/22 12:24:46 $ 
 * 
...
public class OnlineListAction extends BaseAction {
  ...
  static {
    resultClass = new BasicDynaClass("ResultClassOnline", PublicMapDynaBean.class, new DynaProperty[]{
        new DynaProperty("count", Integer.class), new DynaProperty("sid", String.class),
        new DynaProperty("hostName", String.class), new DynaProperty("userName", String.class),
        new DynaProperty("start", String.class), new DynaProperty("last", String.class),
        new DynaProperty("bot", Boolean.class), new DynaProperty("referrer", String.class),
        new DynaProperty("length", Long.class), new DynaProperty("size", Integer.class)});
  }
