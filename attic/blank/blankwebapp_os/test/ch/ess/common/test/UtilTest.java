...
public class UtilTest extends TestCase {
  ...
  public void testTruncateNicely() {
    ...
    assertEquals("&nbsp;&uuml;&auml;&ouml;&Uuml;&Auml;&Ouml;&amp;&quot;&lt;&gt;", Util.truncateNicely(
        "&nbsp;&uuml;&auml;&ouml;&Uuml;&Auml;&Ouml;&amp;&quot;&lt;&gt;", 20, 20, "...", true));
    assertEquals("&nbsp;&uuml;&auml;&ouml;&Uuml;...", Util.truncateNicely(
        "&nbsp;&uuml;&auml;&ouml;&Uuml;&Auml;&Ouml;&amp;&quot;&lt;&gt;", 5, 5, "...", true));
    assertEquals("&nbsp...", Util.truncateNicely("&nbsp;&uuml;&auml;&ouml;&Uuml;&Auml;&Ouml;&amp;&quot;&lt;&gt;", 5, 5,
        "...", false));
   ...
   * 331 0 if (GenericValidator.isBlankOrNull(searchText)) { 332 0 return true;
   * 333 } 334 335 0 searchText = searchText.toLowerCase(); 336 337 0 for
   * (Iterator it = translations.values().iterator(); it.hasNext();) { 338 0
   * String element = (String)it.next(); 339 0 if
   * (element.toLowerCase().indexOf(searchText) != -1) { 340 0 return true; 341 }
   * 342 } 343 344 0 return false; 345 }
   * 
   * @author sr
   */
}