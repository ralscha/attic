...
public class WampWebSocket {
	...
	private final WampConnection connection;
	...
	private WampEventSubscriber getEventSubscriber()
			throws UnsupportedWampActionException {
		// Refresh in case it was removed from the connection
	...
	public WampCallResultMessage call(String procId, Object args, long timeout)
			throws IOException, UnsupportedWampActionException {
	...
	public String call(String procId, Object args, long timeout,
			...
			UnsupportedWampActionException {
	...
	public void publish(String topicId, Object event, boolean excludeMe,
			List<String> eligible) throws IOException, UnsupportedWampActionException {
