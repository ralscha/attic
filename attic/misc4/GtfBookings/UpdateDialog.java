...
public class UpdateDialog extends JDialog implements Runnable
{
	...
	public UpdateDialog(JFrame parent, String drv, String url) {
    ...
    boolean retrieveFiles(String server, String user, String pw) {
        ...
        try {
            ...
            while (ex != null) {
              textArea.append("SQLState: " + ex.getSQLState()+"\n");
              textArea.append("Message:  " + ex.getMessage()+"\n");
              textArea.append("Vendor:   " + ex.getErrorCode()+"\n");
    ...
    void readContFile(BufferedReader dis) throws IOException, NumberFormatException, SQLException {
        StreamTokenizer st;
        String line = null;
        String dateStr = null;
        int type;
    ...
    void readFirmFile(BufferedReader dis) throws IOException, NumberFormatException, SQLException {
        String line = null;
        String dateStr = null;
        StreamTokenizer st;
        int type;
