...
public class FirmLiability extends Liability {
    ...
    /*
    public int hashCode() {
        String str = new String(getGtf_number() + getCurrency() + getAmount() + 
    	             getDeb_acct_mgmt_unit() + getDeb_acct_number() + 
    	             getCre_acct_mgmt_unit() + getCre_acct_number() + 
    	             getValue_date() + getGtf_proc_center());
    	return(str.hashCode());             
    }
    */
    
    public boolean hasEmptyAccountNumbers() {
        if (getDeb_acct_number().equals("") || getDeb_acct_mgmt_unit().equals("") || 
            getCre_acct_number().equals("") || getCre_acct_mgmt_unit().equals("") )  
            return(true);
        else
            return(false);        
    }
