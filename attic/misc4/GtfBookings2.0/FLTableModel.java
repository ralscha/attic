...
public class FLTableModel extends LiabilityTableModel {
    ...
    public FLTableModel() {
        ...
        dataArray = new Object[DbManager.getFirmCollectionSize()][number_of_columns];                
    ...
    void fillDataArray(Iterator e) {
        ...
        while (e.hasNext()) {
            ...
            dataArray[i][ 4] = accountFormat(fl.getDeb_acct_mgmt_unit()+fl.getDeb_acct_number());
            dataArray[i][ 5] = accountFormat(fl.getCre_acct_mgmt_unit()+fl.getCre_acct_number());
