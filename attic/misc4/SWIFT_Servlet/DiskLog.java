...
public class DiskLog {
	...
	private String createLogFileName() {
		...
		return(AppProperties.getProperty("logPath").trim()+File.separator+dateFormat_file.format(cal.getTime()) + ".log");
	}
    ...
    private void writeMessage(char logLevel, String className, String logEntry) {
	...
	public static void log(char logLevel, String className, String logEntry) {
	    instance.writeMessage(logLevel, className, logEntry);    
    }
}