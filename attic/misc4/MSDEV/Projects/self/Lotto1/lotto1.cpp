...
void KopfHTML(ofstream& out, const char* title)
{
   ...
   out << "    <td align=right valign=top width=15%><i>16.12.1995</i>\n";
   out << "  </tr>\n";
   out << "</table>\n";
   out << "<p>\n";
}
...
void OutAlleZiehungenHTML()
{
	...
	ofstream out("Ziehung.htm");
	KopfHTML(out, "Alle Ziehungen des Schweiz. Zahlenlottos");

	out << "<table border>\n  <tr>\n";

	for (jahr = 1995; jahr >= 1986; jahr--)
		out << "    <td><a href=\"#" << jahr << "\">" << jahr << "</a>\n";
   out << "  </tr>\n  <tr>\n";
   for (jahr = 1985; jahr >= 1976; jahr--)
		out << "    <td><a href=\"#" << jahr << "\">" << jahr << "</a>\n";
   out << "  </tr>\n  <tr>\n";    
   for (jahr = 1975; jahr >= 1970; jahr--)
		out << "    <td><a href=\"#" << jahr << "\">" << jahr << "</a>\n";
   out << "    <td colspan=4>&#160;\n  </tr>\n</table>" << endl;
...
void OutGeradeUngeradeHTML()
{
	...
	out << "</table>\n</center>\n<p>\n<center><img src=\"gerung1.gif\"></center>\n";
	out << "<p>&#160;\n<p>" << endl;
...
void OutAusstehendHTML()
{
   ...
   out << "  </tr>\n";
	...
	out << "</table>\n</center>\n<p>&#160;\n<p>\n<center><img src=\"auss.gif\"></center>\n";
	out << "</body>\n</html>\n";
