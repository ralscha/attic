...
public class TiefeHoheEndziffernProducer extends Producer {

  private static final String[] templates = { "htealle.vm", "hte42.vm", "hte45.vm", "hte97.vm" };
  private static final String[] htmlFiles =
    { "htealle.shtml", "hte42.shtml", "hte45.shtml", "hte97.shtml" };
  ...
  public void producePage(Database db, Properties props, AusspielungenStatistiken as) {
    try {
      ...
      for (int i = 0; i < 4; i++) {
        tiefe = as.getAusspielungenStatistik(types[i]).getVerteilungTiefeEndziffern();
