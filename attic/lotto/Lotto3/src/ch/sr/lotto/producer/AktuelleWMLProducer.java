...
public class AktuelleWMLProducer extends Producer {

  private static final String template = "l_wml.vm";
  ...
  public void producePage(Database db, Properties props, AusspielungenStatistiken as) {
    try {
      ...
      context.put("date", dateFormat.format(draw.getDrawdate()));
      ...
      context.put("lanz5+", form2.format(lgq[0].getNum5plus()));
      context.put("lbet5+", form.format(lgq[0].getQuota5plus()));
      ...
      //  context.put("lerwartetdatum", dateFormat.format(NextGewinnsumme.nextDatum.getTime()));
      //  context.put("lerwartetsumme", form.format(NextGewinnsumme.nextLottoGewinn));
      //} else {
      ...
      //  context.put("jerwartetdatum", dateFormat.format(NextGewinnsumme.nextDatum.getTime()));
      //  context.put("jerwartetsumme", form.format(NextGewinnsumme.nextJokerGewinn));
      //} else {
      ...
      templ = Velocity.getTemplate(templatePath + template);

      PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(quotenPath + htmlFile)));
