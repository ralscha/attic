...
public class Klasse9Producer extends Producer {

  private static final String[] templates =
    { "klasse9alle.vm", "klasse942.vm", "klasse945.vm", "klasse997.vm" };
  private static final String[] htmlFiles =
    { "klasse9alle.shtml", "klasse942.shtml", "klasse945.shtml", "klasse997.shtml" };
  ...
  public void producePage(Database db, Properties props, AusspielungenStatistiken as) {
    try {
      ...
      klasseMap[0] =
        as.getAusspielungenStatistik(AusspielungenType.ALLE).getVerteilungNeunerKlassen();
      klasseMap[1] =
        as.getAusspielungenStatistik(AusspielungenType.AUS42).getVerteilungNeunerKlassen();
      klasseMap[2] =
        as.getAusspielungenStatistik(AusspielungenType.AUS45).getVerteilungNeunerKlassen();
      klasseMap[3] =
        as.getAusspielungenStatistik(AusspielungenType.AB1997).getVerteilungNeunerKlassen();
