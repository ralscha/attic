...
<html>
<head>
<title>Eingabe Lottozettel: Tips</title>
...
<struts:form action="addTip.do" method="post" name="tipForm" focus="z1" type="lottowin.form.TipForm">
  <misc:trxToken/>
  <blockquote>
    <table width="638">
      <tr>
		 ...
		 <% int rows = model.getRowCount();
			...
			for (int r = 0; r < rows; r++) { %>
			 ...
			 <% if ( (updateid == null) || (updateid.intValue() != Integer.parseInt((String)model.getValueAt(r, 6))) ) { %>
	        	<td colspan="2" align="left"><a href="updateTip.do?id=<%= model.getValueAt(r, 6) %>&page=<%= model.getCurrentPage() %>">Aendern</a>
				&nbsp;<a href="removeTip.do?id=<%= model.getValueAt(r, 6) %>&page=<%= model.getCurrentPage() %>">L&ouml;schen</a></td>			 
			 <%	} else { %>
