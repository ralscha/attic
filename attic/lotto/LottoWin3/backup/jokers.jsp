...
<html>
<head>
<title>Eingabe Lottozettel: Joker</title>
...
<struts:form action="addJoker.do" method="post" name="jokerForm" focus="joker" type="lottowin.form.JokerForm">
  <misc:trxToken/>
  <blockquote>
    <table width="638">
      <tr>
        <td ALIGN="center" width="62" bgcolor="#CCCCCC"><i>Joker</i></td>
        <td colspan="2"></td>
      </tr>
      <tr>
	  ...
	  <tr><td colspan="8">&nbsp;</td></tr>
	   <t:table name="model" scope="session" maxPageItems="10">
	     <tr><td colspan="6" align="right"><%@ include file="tipsindex.jsp"%></td>
		 <td colspan="2">&nbsp;</td></tr>
		 ...
		 <% int rows = model.getRowCount();
			...
			for (int r = 0; r < rows; r++) { %>
      	     <tr>
        	    <td ALIGN="right" <% if (r % 2 == 0) { %>bgcolor="#CCCCCC"<% } else { %>bgcolor="#EEEEEE"<% } %>><table><tr><td align="right"><%= model.getValueAt(r, 0) %></td><td>&nbsp;</td></tr></table></td>
			 <% if ( (updateid == null) || (updateid.intValue() != Integer.parseInt((String)model.getValueAt(r, 1))) ) { %>
	        	<td colspan="2" align="left"><a href="updateJoker.do?id=<%= model.getValueAt(r, 1) %>&page=<%= model.getCurrentPage() %>">Aendern</a>
				&nbsp;<a href="removeJoker.do?id=<%= model.getValueAt(r, 1) %>&page=<%= model.getCurrentPage() %>">L&ouml;schen</a></td>			 
			 <%	} else { %>
