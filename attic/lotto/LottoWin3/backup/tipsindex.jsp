          <t:index>
           ...
           <t:prev>
            ...
            <% } else { %>
             ...
             <img src="images/notFirstPage.gif" hspace="2" width="13" height="16" border="0" alt=""></a></td>
             <td><a href="<%= prevPageURL %>">
             <img src="images/previousPage.gif" border="0" hspace="2" width="13" height="16" alt=""></a></td>
            <% } %>
           </t:prev>
           <t:pages>
           ...
           <t:next>
            ...
            <% } else { %>
              ...
              <img src="images/nextPage.gif" border="0" hspace="2" width="13" height="16" alt=""></a></td>
              <td><a href="<%= lastPageURL %>">
              <img src="images/notLastPage.gif" border="0" hspace="2" width="13" height="16" alt=""></a></td>	  
            <% } %>
           </t:next>
           </tr></table>
          </t:index>