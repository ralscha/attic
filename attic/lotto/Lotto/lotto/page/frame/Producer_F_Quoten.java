...
public class Producer_F_Quoten extends PageProducer {
		
	private static final String header = "head_frame.template";
	private static final String template = "quoten_frame.template";
	private static final String htmlFile = "quoten.html";
	...
	public void producePage(Ausspielungen auss, Properties props) {
		try {
			...
			if ((lgq != null) && (jgq != null)) {
				...
				tw.addVariable("title", "Gewinnquoten");				
				...
				tw.write(quotenFramePath + htmlFile);
			}
