...
public class Producer_F_Haeufigkeit extends PageProducer {

	private static final String header = "head_frame.template";
	private static final String[] templates = {"Hhalle_frame.template", "Hh42_frame.template", "Hh45_frame.template", "Hh97_frame.template",
													  "Hzalle_frame.template", "Hz42_frame.template", "Hz45_frame.template", "Hz97_frame.template"};
	private static final String[] htmlFiles = {"Hhalle.html", "Hh42.html", "Hh45.html", "Hhz97.html",
													  "Hzalle.html", "Hz42.html", "Hz45.html", "Hzz97.html"};
		...
		try {
			...
			for (int i = 0; i < 4; i++) {
				...
				if (orderByHaeufigkeit) {
					...
					tw.addVariable("title", "H&auml;ufigkeit "+TITLES[i]+" sortiert nach Ausspielungen");
					...
					tw.addVariable("title", "H&auml;ufigkeit "+TITLES[i]+" sortiert nach Zahlen");
					...
					tw.write(lottoFramePath + htmlFiles[i + 4]);
				}
			}
