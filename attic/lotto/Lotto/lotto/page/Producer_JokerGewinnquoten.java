...
public class Producer_JokerGewinnquoten extends PageProducer {
	...
	public Producer_JokerGewinnquoten() {
	...
	private PrintWriter writeHTMLHeader(int year) throws IOException, FileNotFoundException {
		PrintWriter pw = new PrintWriter(
                   		new BufferedWriter(new FileWriter(quotenPath + "jgq" + year + ".shtml")));

		pw.println("<html>");
		pw.println("<head>");
		pw.print("<title>Schweizer Zahlenlotto: Joker Gewinnquoten ");
		pw.print(year);
		pw.println("</title>");
	...
	private void writeHead(PrintWriter pw, Ziehung zie) {
		pw.println("<br>");
		pw.println("<p class=\"subTitle\">Joker Gewinnquoten ");
	...
	private void writeJokerGewinnquote(PrintWriter pw, JokerGewinnquote jgq, Ziehung zie) {
		...
		pw.print(form.format(jgq.getQuote(GewinnquoteType.JACKPOT)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcsa\">");
		pw.print(form2.format(jgq.getAnzahl(GewinnquoteType.RICHTIGE_6)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcs\">");
		pw.print(form.format(jgq.getQuote(GewinnquoteType.RICHTIGE_6)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcsa\">");
		pw.print(form2.format(jgq.getAnzahl(GewinnquoteType.RICHTIGE_5)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcs\">");
		pw.print(form.format(jgq.getQuote(GewinnquoteType.RICHTIGE_5)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcsa\">");
		pw.print(form2.format(jgq.getAnzahl(GewinnquoteType.RICHTIGE_4)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcs\">");
		pw.print(form.format(jgq.getQuote(GewinnquoteType.RICHTIGE_4)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcsa\">");
		pw.print(form2.format(jgq.getAnzahl(GewinnquoteType.RICHTIGE_3)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcs\">");
		pw.print(form.format(jgq.getQuote(GewinnquoteType.RICHTIGE_3)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcsa\">");
		pw.print(form2.format(jgq.getAnzahl(GewinnquoteType.RICHTIGE_2)));
		pw.println("</td>");

		pw.print("	<TD ALIGN=\"RIGHT\" class=\"tcs\">");
		pw.print(form.format(jgq.getQuote(GewinnquoteType.RICHTIGE_2)));
		pw.println("</td>");
