...
public class UserService {
	...
	private void preModify(User entity) {
		if (StringUtils.hasText(entity.getNewPassword())) {
			...
			entity.setPasswordHash(this.passwordEncoder.encode(entity.getNewPassword()));
			System.out.println("PasswordEncode:"+this.passwordEncoder.encode(entity.getNewPassword()));
		}
		else {
