...
Ext.application({
	...
	requires: [ 'Ext.MessageBox', 'Weather.view.Main' ],
    ...
    launch: function() {
        ...
        Deft.Injector.configure({         
        	weatherStore: 'Weather.store.Weather',
        	messageBus: 'Ext.util.Observable',
        	
        	weatherAPI: {
                value: 'http://api.openweathermap.org/data/2.5/weather?APPID=fd32f6f87ea2c5227a2d5b3960b29d98&units=metric'
            },
            defaultCountry: {
                value: 'Dublin,ie'
            }
