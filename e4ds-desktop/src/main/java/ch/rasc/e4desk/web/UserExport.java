...
public class UserExport {
	...
	public void userExport(HttpServletResponse response, Locale locale,
		...
		Sheet sheet = workbook
				.createSheet(this.messageSource.getMessage("user", null, locale));

		Row row = sheet.createRow(0);
		createCell(row, 0, this.messageSource.getMessage("user_email", null, locale),
				titleStyle);
		createCell(row, 1, this.messageSource.getMessage("user_firstname", null, locale),
				titleStyle);
		createCell(row, 2, this.messageSource.getMessage("user_name", null, locale),
				titleStyle);
		createCell(row, 3, this.messageSource.getMessage("user_active", null, locale),
				titleStyle);
