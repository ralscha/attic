Ext.define('${jsAppNamespace}.controller.LoggingEvent', {
	...
	deleteAll: function() {
		...
		loggingEventService.deleteAll(filter && filter.value, function() {
			${jsAppNamespace}.ux.window.Notification.info(i18n.successful, i18n.logevents_deleted);
			this.doGridRefresh();
		}, this);
	},
	...
	addTestData: function() {
		loggingEventService.addTestData(function() {
			${jsAppNamespace}.ux.window.Notification
