Ext.define('${jsAppNamespace}.view.user.Grid', {
	extend: 'Ext.grid.Panel',
	requires: [ '${jsAppNamespace}.ux.form.field.FilterField', '${jsAppNamespace}.store.Users' ],
	...
	initComponent: function() {
		...
		me.store = Ext.create('${jsAppNamespace}.store.Users');
