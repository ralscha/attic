...
public class AppUser extends TableImpl<AppUserRecord> {
	...
	public final TableField<AppUserRecord, String> AUTHORITY = createField(
			DSL.name("authority"), SQLDataType.VARCHAR(10).nullable(false), this, "");
	...
	public final TableField<AppUserRecord, LocalDateTime> EXPIRED = createField(
			DSL.name("expired"), SQLDataType.LOCALDATETIME(0).defaultValue(
					DSL.field("NULL", SQLDataType.LOCALDATETIME)),
			this, "");
	...
	public final TableField<AppUserRecord, LocalDateTime> LAST_ACCESS = createField(
			DSL.name("last_access"), SQLDataType.LOCALDATETIME(0).defaultValue(
					DSL.field("NULL", SQLDataType.LOCALDATETIME)),
			this, "");
	...
	public final TableField<AppUserRecord, String> CONFIRMATION_TOKEN = createField(
			DSL.name("confirmation_token"),
			SQLDataType.CHAR(35).defaultValue(DSL.field("NULL", SQLDataType.CHAR)), this,
			"");
	...
	public final TableField<AppUserRecord, LocalDateTime> CONFIRMATION_TOKEN_CREATED = createField(
			DSL.name("confirmation_token_created"), SQLDataType.LOCALDATETIME(0)
	...
	public final TableField<AppUserRecord, LocalDateTime> PASSWORD_RESET_TOKEN_CREATED = createField(
			DSL.name("password_reset_token_created"), SQLDataType.LOCALDATETIME(0)
					.defaultValue(DSL.field("NULL", SQLDataType.LOCALDATETIME)),
			this, "");
	...
	public List<Check<AppUserRecord>> getChecks() {
		return Arrays.asList(Internal.createCheck(this, DSL.name("CONSTRAINT_1"),
				"`authority` in ('USER','ADMIN')", true));
	}
	...
	public <U> SelectField<U> mapping(
			Function12<? super Long, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? extends U> from) {
