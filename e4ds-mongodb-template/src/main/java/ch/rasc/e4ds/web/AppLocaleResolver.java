...
import ch.rasc.e4ds.service.MongoDBUserDetails;
...
public class AppLocaleResolver extends AbstractLocaleResolver {
	...
	public Locale resolveLocale(HttpServletRequest request) {
		...
		} else if (authentication.getPrincipal() instanceof MongoDBUserDetails) {
			return ((MongoDBUserDetails) authentication.getPrincipal()).getLocale();
