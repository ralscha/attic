Ext.define('Proto.view.usersettings.Window', {
	extend: 'Ext.window.Window',
	requires: [ 'Proto.view.usersettings.Controller', 'Proto.view.usersettings.ViewModel' ],
	stateId: 'Proto.view.usersettings.Window',
	stateful: true,

	controller: {
		xclass: 'Proto.view.usersettings.Controller'
	},

	viewModel: {
		xclass: 'Proto.view.usersettings.ViewModel'
	},
	...
	items: [ {
		...
		items: [ {
			...
			stateId: 'Proto.view.usersettings.Window.PersistentLogins',
			stateful: true,
			columns: [ {
