...
public abstract class AutoDocument {
	...
	@JsonCreator
	public static AutoDocument create(@JsonProperty("items") List<Item> items) {
	...
	public static abstract class Item {
		...
		@JsonCreator
		public static Item create(@JsonProperty("id") int id,
				@JsonProperty("name") String name,
				@JsonProperty("description") @Nullable String description,
				@JsonProperty("evaluation") List<Evaluation> evaluation,
				@JsonProperty("foo") int foo, @JsonProperty("bar") boolean bar,
			...
			return new AutoValue_AutoDocument_Item(id, name, description,
					ImmutableList.copyOf(evaluation), foo, bar, tid, gname, bdescription,
					ImmutableList.copyOf(nevaluation), hfoo, ybar,
	...
	public static abstract class Evaluation {
		...
		@JsonCreator
		public static Evaluation create(@JsonProperty("comment") String comment,
				// @JsonProperty("stars") int stars) {
				@JsonProperty("stars") @Nullable Stars stars) {
			return new AutoValue_AutoDocument_Evaluation(comment,
					// stars);
