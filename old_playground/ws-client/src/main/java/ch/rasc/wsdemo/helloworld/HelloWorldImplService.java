...
public class HelloWorldImplService extends Service {
	...
	private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName(
			"http://wsdemo.rasc.ch/", "HelloWorldImplService");

	static {
		URL url = null;
		WebServiceException e = null;
		try {
			url = new URL("http://localhost:8080/cxf/HelloWorld?wsdl");
		}
	...
	public HelloWorldImpl getHelloWorldImplPort() {
		return super.getPort(new QName("http://wsdemo.rasc.ch/", "HelloWorldImplPort"),
