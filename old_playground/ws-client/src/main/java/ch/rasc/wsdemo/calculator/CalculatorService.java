 ...
 *
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://wsdemo.rasc.ch/",
...
public class CalculatorService extends Service {
	...
	private final static QName CALCULATORSERVICE_QNAME = new QName(
			"http://wsdemo.rasc.ch/", "CalculatorService");

	static {
		URL url = null;
		WebServiceException e = null;
		try {
			url = new URL("http://localhost:8080/cxf/Calculator?wsdl");
		}
	...
	public Calculator getCalculatorPort() {
		return super.getPort(new QName("http://wsdemo.rasc.ch/", "CalculatorPort"),
				Calculator.class);
	}
