 ...
 *         &lt;element name="person" maxOccurs="unbounded" minOccurs="2">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlRootElement(name = "mergePersonsRequest")
public class MergePersonsRequest {

    @XmlElement(required = true)
    protected HeaderType header;
    @XmlElement(required = true)
    protected List<MergePersonsRequest.Person> person;
     ...
     * {@link MergePersonsRequest.Person }
     * 
     * 
     */
    public List<MergePersonsRequest.Person> getPerson() {
        if (person == null) {
            person = new ArrayList<MergePersonsRequest.Person>();
        }
        return this.person;
    }
