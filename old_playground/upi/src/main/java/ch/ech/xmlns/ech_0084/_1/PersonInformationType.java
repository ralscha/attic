...
public class PersonInformationType {
    ...
    @XmlElement(required = true)
    protected PersonInformationType.Nationality nationality;
     ...
     * @return
     *     possible object is
     *     {@link PersonInformationType.Nationality }
     *     
     */
    public PersonInformationType.Nationality getNationality() {
        return nationality;
    }
     ...
     *     
     */
    public void setNationality(PersonInformationType.Nationality value) {
