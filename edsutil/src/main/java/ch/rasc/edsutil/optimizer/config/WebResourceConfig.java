...
public class WebResourceConfig {
	...
	public boolean isDevScriptOrLink() {
		return this.dev != null && (this.dev == WebResourceType.link
				|| this.dev == WebResourceType.script);
	}
	...
	public boolean isProdScriptOrLink() {
		return this.prod != null && (this.prod == WebResourceType.script
				|| this.prod == WebResourceType.link);
	}
}
