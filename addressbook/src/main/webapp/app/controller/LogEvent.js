Ext.define('Ab.controller.LogEvent', {
	...
	deleteAll: function() {
		...
		logEventService.deleteAll(filter && filter.value, function() {
			Ab.ux.window.Notification.info(i18n.successful, i18n.logevents_deleted);
			this.doGridRefresh();
		}, this);
	},
	...
	addTestData: function() {
		logEventService.addTestData(function() {
			Ab.ux.window.Notification.info(i18n.successful, i18n.logevents_testinserted);
			this.doGridRefresh();
		}, this);
