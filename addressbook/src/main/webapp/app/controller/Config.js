Ext.define('Ab.controller.Config', {
	...
	onSaveButtonClick: function() {
		...
		appConfigurationService.save(form.getFieldValues(), function() {
			Ab.ux.window.Notification.info(i18n.successful, i18n.config_saved);
		});
	},
		...
		if (form.isValid()) {
			appConfigurationService.save(form.getFieldValues(), function() {
				...
				appConfigurationService.sendTestEmail(testReceiver, function() {
					Ab.ux.window.Notification.info(i18n.successful, i18n.config_testEmailsent);
				});
			});
		} else {
			appConfigurationService.sendTestEmail(testReceiver, function() {
