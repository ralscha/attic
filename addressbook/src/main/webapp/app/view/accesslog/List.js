Ext.define('Ab.view.accesslog.List', {
	extend: 'Ext.grid.Panel',
	controller: 'Ab.controller.AccessLog',
	title: i18n.accesslog,
	closable: true,
	border: true,

	requires: [ 'Ab.ux.form.field.FilterField', 'Ab.store.AccessLogs' ],

	initComponent: function() {
		var me = this;

		me.store = Ext.create('Ab.store.AccessLogs');
