...
Ext.define('CarTracker.ux.chart.SmartLegend', {
    extend: 'CarTracker.ux.chart.Legend',
    
    requires: [ 'CarTracker.ux.chart.SmartLegendItem' ],
    ...
    createLegendItem: function(series, yFieldIndex) {
        ...
        return new CarTracker.ux.chart.SmartLegendItem(conf);
    },
    ...
    calcPosition: function() {
        var me = this,
            ...
            surface = me.chart.surface,
            mfloor = Math.floor,
            insets, lWidth, lHeight, sWidth, sHeight,
