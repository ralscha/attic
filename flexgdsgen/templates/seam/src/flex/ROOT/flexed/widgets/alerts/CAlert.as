package flexed.widgets.alerts
{
	...
	public class CAlert extends Alert
	{
		...
		public static function info(message:String, closehandler:Function=null):void{
			var a:Alert = show(message, ResourceManager.getInstance().getString('common','Information'), Alert.OK, null, closehandler, iconInfo);
			a.height = 130;
		}
		
		public static function error(message:String, closehandler:Function=null):void{
			var a:Alert = show(message, ResourceManager.getInstance().getString('common','Error'), Alert.OK, null, closehandler, iconError);
			a.height = 130;
		}
		
		public static function confirm(message:String, closehandler:Function=null):void{
			var a:Alert = show(message, ResourceManager.getInstance().getString('common','Confirmation'), Alert.YES | Alert.NO, null, closehandler, iconConfirm);
			a.height = 130;
		}
